...
> **Entrypoint:** [AGENTS.md](../AGENTS.md) → this file → [CODEBASE.md](../CODEBASE.md) → domain skill.

---

## 1. Session startup (mandatory)

1. Read [CODEBASE.md](../CODEBASE.md) — repo map, ports, page template, conventions.
2. Read [CODING_STANDARDS.md](../CODING_STANDARDS.md) — non-negotiable rules (CSS tokens, TypeScript, no raw hex).
