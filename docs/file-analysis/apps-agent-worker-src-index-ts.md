...
**Path:** `apps/agent-worker/src/index.ts` (40 lines)  
...
--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What does `shutdown` do?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** See **apps/agent-worker/src/index.ts:23** — check parameters, return value, and side effects.
