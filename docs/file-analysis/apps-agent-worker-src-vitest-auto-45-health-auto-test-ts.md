# 45-health.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/agent-worker/src/vitest-auto/45-health.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "45-health.auto.test" apps packages --glob '*.{ts,tsx}'`.
