...
`apps/api/src/graphql/tenantScope.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `tenantScopeMatches`?"

### `assertTenantScope`

- **Approx. line:** 10
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `assertTenantScope`?"

### `resolveTenantIdForScope`

- **Approx. line:** 19
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `resolveTenantIdForScope`?"

### `scopedTenantId`

- **Approx. line:** 31
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `scopedTenantId`?"


## Interview Questions

- How is tenant resolved: subdomain, header, or JWT claim?
- Walk me through tenantScopeMatches line by line.
...
```bash
rg "tenantScope" apps packages --glob '*.{ts,tsx}'
```
