...
`apps/api/src/middleware/planGate.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `resolveTenantPlan`?"

### `requireFeature`

- **Approx. line:** 11
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `requireFeature`?"

### `planGateMiddleware`

- **Approx. line:** 26
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `planGateMiddleware`?"


## Interview Questions

- Walk me through resolveTenantPlan line by line.
