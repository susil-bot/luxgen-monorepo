...
`apps/api/src/middleware/tenantHeaders.ts`
...
- **Workspace packages:** @luxgen/db, @luxgen/config
...
- **Interview:** "What are inputs, outputs, and side effects of `tenantHeadersMiddleware`?"

### `tenantBrandingMiddleware`

- **Approx. line:** 92
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `tenantBrandingMiddleware`?"

### `tenantSecurityHeadersMiddleware`

- **Approx. line:** 133
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `tenantSecurityHeadersMiddleware`?"

### `tenantRateLimitMiddleware`

- **Approx. line:** 216
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `tenantRateLimitMiddleware`?"


## Interview Questions

- How is tenant resolved: subdomain, header, or JWT claim?
- Walk me through tenantHeadersMiddleware line by line.
...
```bash
rg "tenantHeaders" apps packages --glob '*.{ts,tsx}'
```
