...
`apps/api/src/schema/engagement/engagementDashboardStats/typeDefs.ts`
...
- `EngagementDashboardStatsTypeDefs`
...
- Walk me through EngagementDashboardStatsTypeDefs line by line.
...
```bash
rg "typeDefs" apps packages --glob '*.{ts,tsx}'
```
