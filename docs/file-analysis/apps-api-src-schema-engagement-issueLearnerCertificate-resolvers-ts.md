...
`apps/api/src/schema/engagement/issueLearnerCertificate/resolvers.ts`
...
- `IssueLearnerCertificateResolvers`
...
- **Interview:** "What are inputs, outputs, and side effects of `uid`?"


## Interview Questions

- Walk me through IssueLearnerCertificateResolvers line by line.
