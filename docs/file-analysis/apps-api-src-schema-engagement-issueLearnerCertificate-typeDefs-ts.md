...
`apps/api/src/schema/engagement/issueLearnerCertificate/typeDefs.ts`
...
- `IssueLearnerCertificateTypeDefs`
...
- Walk me through IssueLearnerCertificateTypeDefs line by line.
