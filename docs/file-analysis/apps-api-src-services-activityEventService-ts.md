...
`apps/api/src/services/activityEventService.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `encodeActivityCursor`?"

### `decodeActivityCursor`

- **Approx. line:** 28
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `decodeActivityCursor`?"

### `actorFromContext`

- **Approx. line:** 605
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `actorFromContext`?"


## Interview Questions

- Walk me through ActivityEventConnection line by line.
...
```bash
rg "activityEventService" apps packages --glob '*.{ts,tsx}'
```
