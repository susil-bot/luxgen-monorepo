...
- **Interview:** "What are inputs, outputs, and side effects of `makeCode`?"


## Interview Questions

- Walk me through certificateService line by line.
...
```bash
rg "certificateService" apps packages --glob '*.{ts,tsx}'
```
