# courseProgressPercentService.ts

## File Path

`apps/api/src/services/courseProgressPercentService.ts`
...
- Walk me through courseProgressPercentService line by line.
...
```bash
rg "courseProgressPercentService" apps packages --glob '*.{ts,tsx}'
```
