# authRoutes.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/authRoutes.test.ts` (479 lines)  
...
**ANS.** Search imports: `rg "authRoutes.test" apps packages --glob '*.{ts,tsx}'`.
