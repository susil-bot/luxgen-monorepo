# automationService.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/automationService.test.ts` (61 lines)  
...
**ANS.** Search imports: `rg "automationService.test" apps packages --glob '*.{ts,tsx}'`.
