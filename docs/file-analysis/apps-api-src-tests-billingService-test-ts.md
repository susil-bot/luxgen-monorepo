# billingService.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/billingService.test.ts` (54 lines)  
...
**ANS.** Search imports: `rg "billingService.test" apps packages --glob '*.{ts,tsx}'`.
