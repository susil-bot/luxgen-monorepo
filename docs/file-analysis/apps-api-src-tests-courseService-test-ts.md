# courseService.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/courseService.test.ts` (42 lines)  
...
**ANS.** Search imports: `rg "courseService.test" apps packages --glob '*.{ts,tsx}'`.
