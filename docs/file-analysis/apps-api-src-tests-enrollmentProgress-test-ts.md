# enrollmentProgress.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/enrollmentProgress.test.ts` (131 lines)  
...
**ANS.** Search imports: `rg "enrollmentProgress.test" apps packages --glob '*.{ts,tsx}'`.
