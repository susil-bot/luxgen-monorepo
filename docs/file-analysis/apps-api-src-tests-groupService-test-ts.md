# groupService.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/groupService.test.ts` (76 lines)  
...
**ANS.** Search imports: `rg "groupService.test" apps packages --glob '*.{ts,tsx}'`.
