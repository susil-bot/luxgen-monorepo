# listingService.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/listingService.test.ts` (57 lines)  
...
**ANS.** Search imports: `rg "listingService.test" apps packages --glob '*.{ts,tsx}'`.
