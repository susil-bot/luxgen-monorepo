# projectItem.moveStatus.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/projectItem.moveStatus.test.ts` (37 lines)  
...
**ANS.** Search imports: `rg "projectItem.moveStatus.test" apps packages --glob '*.{ts,tsx}'`.
