# projectItem.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/projectItem.test.ts` (111 lines)  
...
**ANS.** Search imports: `rg "projectItem.test" apps packages --glob '*.{ts,tsx}'`.
