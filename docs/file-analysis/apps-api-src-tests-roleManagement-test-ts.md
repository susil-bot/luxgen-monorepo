# roleManagement.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/roleManagement.test.ts` (506 lines)  
...
**ANS.** Search imports: `rg "roleManagement.test" apps packages --glob '*.{ts,tsx}'`.
