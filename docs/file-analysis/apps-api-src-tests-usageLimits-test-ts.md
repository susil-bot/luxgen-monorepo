# usageLimits.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/usageLimits.test.ts` (14 lines)  
...
**ANS.** Search imports: `rg "usageLimits.test" apps packages --glob '*.{ts,tsx}'`.
