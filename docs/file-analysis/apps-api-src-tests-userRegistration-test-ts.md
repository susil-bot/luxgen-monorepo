# userRegistration.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/tests/userRegistration.test.ts` (326 lines)  
...
**ANS.** Search imports: `rg "userRegistration.test" apps packages --glob '*.{ts,tsx}'`.
