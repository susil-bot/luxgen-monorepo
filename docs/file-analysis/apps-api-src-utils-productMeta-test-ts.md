# productMeta.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/utils/productMeta.test.ts` (50 lines)  
...
**ANS.** Search imports: `rg "productMeta.test" apps packages --glob '*.{ts,tsx}'`.
