# 01-userService.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/01-userService.auto.test.ts` (14 lines)  
...
**ANS.** Search imports: `rg "01-userService.auto.test" apps packages --glob '*.{ts,tsx}'`.
