# 02-courseCommerce.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/02-courseCommerce.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "02-courseCommerce.auto.test" apps packages --glob '*.{ts,tsx}'`.
