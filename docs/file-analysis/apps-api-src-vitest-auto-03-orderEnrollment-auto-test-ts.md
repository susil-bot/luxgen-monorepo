# 03-orderEnrollment.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/03-orderEnrollment.auto.test.ts` (59 lines)  
...
**ANS.** Search imports: `rg "03-orderEnrollment.auto.test" apps packages --glob '*.{ts,tsx}'`.
