# 05-billingService.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/05-billingService.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "05-billingService.auto.test" apps packages --glob '*.{ts,tsx}'`.
