# 08-learnerTypes.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/08-learnerTypes.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "08-learnerTypes.auto.test" apps packages --glob '*.{ts,tsx}'`.
