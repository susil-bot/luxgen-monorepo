# 09-listingSlug.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/09-listingSlug.auto.test.ts` (16 lines)  
...
**ANS.** Search imports: `rg "09-listingSlug.auto.test" apps packages --glob '*.{ts,tsx}'`.
