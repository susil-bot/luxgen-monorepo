# 10-certificateStats.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/10-certificateStats.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "10-certificateStats.auto.test" apps packages --glob '*.{ts,tsx}'`.
