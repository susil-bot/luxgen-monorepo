# 12-courseResolver.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/12-courseResolver.auto.test.ts` (34 lines)  
...
**ANS.** Search imports: `rg "12-courseResolver.auto.test" apps packages --glob '*.{ts,tsx}'`.
