# 15-billingResolver.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/15-billingResolver.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "15-billingResolver.auto.test" apps packages --glob '*.{ts,tsx}'`.
