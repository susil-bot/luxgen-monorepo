# 17-learnerResolver.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/17-learnerResolver.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "17-learnerResolver.auto.test" apps packages --glob '*.{ts,tsx}'`.
