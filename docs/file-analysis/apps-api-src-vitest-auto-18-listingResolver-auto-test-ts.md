# 18-listingResolver.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/18-listingResolver.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "18-listingResolver.auto.test" apps packages --glob '*.{ts,tsx}'`.
