# 44-redis.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/api/src/vitest-auto/44-redis.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "44-redis.auto.test" apps packages --glob '*.{ts,tsx}'`.
