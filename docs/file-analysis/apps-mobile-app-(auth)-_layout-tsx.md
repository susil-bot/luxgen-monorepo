...
**Path:** `apps/mobile/app/(auth)/_layout.tsx` (6 lines)  
...
**ANS.** Application module. Main exports: `AuthLayout`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `AuthLayout`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **apps/mobile/app/(auth)/_layout.tsx:3** and read the function body.
