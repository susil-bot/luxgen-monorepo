...
`apps/mobile/components/MobileBootstrap.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `MobileBootstrap`?"


## Interview Questions

- Walk me through MobileBootstrap line by line.
...
```bash
rg "MobileBootstrap" apps packages --glob '*.{ts,tsx}'
```
