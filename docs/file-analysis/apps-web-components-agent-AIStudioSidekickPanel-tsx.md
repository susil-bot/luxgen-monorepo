# AIStudioSidekickPanel.tsx

## File Path

`apps/web/components/agent/AIStudioSidekickPanel.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `AIStudioSidekickPanel`?"


## Interview Questions

- Walk me through AIStudioSidekickPanel line by line.
...
```bash
rg "AIStudioSidekickPanel" apps packages --glob '*.{ts,tsx}'
```
