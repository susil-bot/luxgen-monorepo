...
- **Interview:** "What are inputs, outputs, and side effects of `connect`?"


## Interview Questions

- Walk me through HeadlessTaskPanel line by line.
...
```bash
rg "HeadlessTaskPanel" apps packages --glob '*.{ts,tsx}'
```
