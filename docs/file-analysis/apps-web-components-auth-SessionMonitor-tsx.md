...
`apps/web/components/auth/SessionMonitor.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `SessionMonitor`?"

### `handleInvalid`

- **Approx. line:** 21
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleInvalid`?"

### `check`

- **Approx. line:** 37
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `check`?"

### `onVisibility`

- **Approx. line:** 47
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `onVisibility`?"


## Interview Questions

- Walk me through SessionMonitor line by line.
...
```bash
rg "SessionMonitor" apps packages --glob '*.{ts,tsx}'
```
