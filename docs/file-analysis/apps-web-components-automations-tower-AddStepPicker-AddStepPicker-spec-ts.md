# AddStepPicker.spec.ts

## File Path

`apps/web/components/automations/tower/AddStepPicker/AddStepPicker.spec.ts`
...
- Walk me through AddStepPicker.spec.ts line by line.
...
```bash
rg "AddStepPicker.spec" apps packages --glob '*.{ts,tsx}'
```
