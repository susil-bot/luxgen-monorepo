# AddStepPicker.spec.ts — Brief + Junior Q&A

**Path:** `apps/web/components/automations/tower/AddStepPicker/AddStepPicker.spec.ts` (12 lines)  
...
**ANS.** Search imports: `rg "AddStepPicker.spec" apps packages --glob '*.{ts,tsx}'`.
