...
`apps/web/components/automations/tower/AddStepPicker/AddStepPicker.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `AddStepPicker`?"

### `handlePointerDown`

- **Approx. line:** 25
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handlePointerDown`?"

### `handleKeyDown`

- **Approx. line:** 31
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleKeyDown`?"


## Interview Questions

- Walk me through AddStepPicker line by line.
...
```bash
rg "AddStepPicker" apps packages --glob '*.{ts,tsx}'
```
