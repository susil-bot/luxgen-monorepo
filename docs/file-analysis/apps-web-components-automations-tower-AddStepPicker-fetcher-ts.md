...
`apps/web/components/automations/tower/AddStepPicker/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchAddStepPickerData`?"


## Interview Questions

- Walk me through AddStepPickerData line by line.
