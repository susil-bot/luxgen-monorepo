# FlowConfigFieldInput.spec.ts

## File Path

`apps/web/components/automations/tower/FlowConfigFieldInput/FlowConfigFieldInput.spec.ts`
...
- Walk me through FlowConfigFieldInput.spec.ts line by line.
...
```bash
rg "FlowConfigFieldInput.spec" apps packages --glob '*.{ts,tsx}'
```
