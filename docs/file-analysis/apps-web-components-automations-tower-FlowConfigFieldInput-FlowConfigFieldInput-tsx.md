# FlowConfigFieldInput.tsx

## File Path

`apps/web/components/automations/tower/FlowConfigFieldInput/FlowConfigFieldInput.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `FlowConfigFieldInput`?"


## Interview Questions

- Walk me through FlowConfigFieldInputProps line by line.
...
```bash
rg "FlowConfigFieldInput" apps packages --glob '*.{ts,tsx}'
```
