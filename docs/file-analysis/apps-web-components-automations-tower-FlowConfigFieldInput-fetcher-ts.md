...
`apps/web/components/automations/tower/FlowConfigFieldInput/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchFlowConfigFieldInputData`?"


## Interview Questions

- Walk me through FlowConfigFieldInputData line by line.
