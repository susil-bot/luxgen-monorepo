...
`apps/web/components/automations/tower/FlowConfigFieldInput/index.ts`
...
- `fetchFlowConfigFieldInputData`
- `flowConfigFieldInputFixtures`
- `flowConfigFieldInputStyles`
- `FlowConfigFieldInputTranslations`
...
- Walk me through FlowConfigFieldInput line by line.
