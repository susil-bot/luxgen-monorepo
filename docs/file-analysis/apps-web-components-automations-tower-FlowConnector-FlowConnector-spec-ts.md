# FlowConnector.spec.ts — Brief + Junior Q&A

**Path:** `apps/web/components/automations/tower/FlowConnector/FlowConnector.spec.ts` (12 lines)  
...
**ANS.** Search imports: `rg "FlowConnector.spec" apps packages --glob '*.{ts,tsx}'`.
