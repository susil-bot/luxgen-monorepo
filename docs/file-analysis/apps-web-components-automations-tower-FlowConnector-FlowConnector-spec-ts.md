# FlowConnector.spec.ts

## File Path

`apps/web/components/automations/tower/FlowConnector/FlowConnector.spec.ts`
...
- Walk me through FlowConnector.spec.ts line by line.
...
```bash
rg "FlowConnector.spec" apps packages --glob '*.{ts,tsx}'
```
