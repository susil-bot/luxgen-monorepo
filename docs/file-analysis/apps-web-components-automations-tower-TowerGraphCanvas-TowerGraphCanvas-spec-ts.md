# TowerGraphCanvas.spec.ts

## File Path

`apps/web/components/automations/tower/TowerGraphCanvas/TowerGraphCanvas.spec.ts`
...
- Walk me through TowerGraphCanvas.spec.ts line by line.
...
```bash
rg "TowerGraphCanvas.spec" apps packages --glob '*.{ts,tsx}'
```
