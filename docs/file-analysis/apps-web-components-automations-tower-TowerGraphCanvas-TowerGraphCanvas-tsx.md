# TowerGraphCanvas.tsx

## File Path

`apps/web/components/automations/tower/TowerGraphCanvas/TowerGraphCanvas.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `TowerGraphCanvas`?"
...
```bash
rg "TowerGraphCanvas" apps packages --glob '*.{ts,tsx}'
```
