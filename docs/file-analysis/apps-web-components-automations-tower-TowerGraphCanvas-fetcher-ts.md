...
`apps/web/components/automations/tower/TowerGraphCanvas/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchTowerGraphCanvasData`?"


## Interview Questions

- Walk me through TowerGraphCanvasData line by line.
