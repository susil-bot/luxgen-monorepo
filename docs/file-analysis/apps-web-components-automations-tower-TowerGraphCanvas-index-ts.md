...
`apps/web/components/automations/tower/TowerGraphCanvas/index.ts`
...
- `TowerGraphCanvas`
- `fetchTowerGraphCanvasData`
- `towerGraphCanvasFixtures`
- `towerGraphCanvasStyles`
- `TowerGraphCanvasTranslations`
...
- Walk me through TowerGraphCanvas line by line.
