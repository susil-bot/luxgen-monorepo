...
**Path:** `apps/web/components/automations/tower/TowerGraphCanvas/styles.ts` (5 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/components/automations/tower/TowerGraphCanvas/styles.ts:3** and read the function body.
