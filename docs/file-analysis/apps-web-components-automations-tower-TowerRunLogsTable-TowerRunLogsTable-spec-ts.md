# TowerRunLogsTable.spec.ts

## File Path

`apps/web/components/automations/tower/TowerRunLogsTable/TowerRunLogsTable.spec.ts`
...
- Walk me through TowerRunLogsTable.spec.ts line by line.
...
```bash
rg "TowerRunLogsTable.spec" apps packages --glob '*.{ts,tsx}'
```
