...
`apps/web/components/automations/tower/TowerRunLogsTable/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchTowerRunLogsTableData`?"


## Interview Questions

- Walk me through TowerRunLogsTableData line by line.
