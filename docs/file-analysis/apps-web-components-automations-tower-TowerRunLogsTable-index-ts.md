...
`apps/web/components/automations/tower/TowerRunLogsTable/index.ts`
...
- `TowerRunLogsTable`
- `fetchTowerRunLogsTableData`
- `towerRunLogsTableFixtures`
- `towerRunLogsTableStyles`
- `TowerRunLogsTableTranslations`
...
- Walk me through TowerRunLogsTable line by line.
