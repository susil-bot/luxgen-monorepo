...
`apps/web/components/automations/tower/TowerShell/TowerShell.spec.ts`
...
- Walk me through TowerShell.spec.ts line by line.
...
```bash
rg "TowerShell.spec" apps packages --glob '*.{ts,tsx}'
```
