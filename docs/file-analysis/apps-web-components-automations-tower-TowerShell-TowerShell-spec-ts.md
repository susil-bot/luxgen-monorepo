# TowerShell.spec.ts — Brief + Junior Q&A

**Path:** `apps/web/components/automations/tower/TowerShell/TowerShell.spec.ts` (12 lines)  
...
**ANS.** Search imports: `rg "TowerShell.spec" apps packages --glob '*.{ts,tsx}'`.
