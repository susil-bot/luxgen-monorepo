...
`apps/web/components/automations/tower/TowerShell/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchTowerShellData`?"


## Interview Questions

- Walk me through TowerShellData line by line.
