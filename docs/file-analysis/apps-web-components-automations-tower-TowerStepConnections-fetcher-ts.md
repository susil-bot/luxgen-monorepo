...
`apps/web/components/automations/tower/TowerStepConnections/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchTowerStepConnectionsData`?"


## Interview Questions

- Walk me through TowerStepConnectionsData line by line.
