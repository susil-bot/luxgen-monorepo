...
`apps/web/components/automations/tower/TowerStepConnections/index.ts`
...
- `fetchTowerStepConnectionsData`
- `towerStepConnectionsFixtures`
- `towerStepConnectionsStyles`
- `TowerStepConnectionsTranslations`
