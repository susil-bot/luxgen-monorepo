...
**Path:** `apps/web/components/automations/tower/TowerStepConnections/styles.ts` (5 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/components/automations/tower/TowerStepConnections/styles.ts:3** and read the function body.
