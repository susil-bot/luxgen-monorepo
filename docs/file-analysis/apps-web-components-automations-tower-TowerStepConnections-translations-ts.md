...
`apps/web/components/automations/tower/TowerStepConnections/translations.ts`
...
- Walk me through TowerStepConnectionsTranslations line by line.
...
```bash
rg "translations" apps packages --glob '*.{ts,tsx}'
```
