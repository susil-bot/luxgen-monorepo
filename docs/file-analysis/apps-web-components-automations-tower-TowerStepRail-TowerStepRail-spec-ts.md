# TowerStepRail.spec.ts — Brief + Junior Q&A

**Path:** `apps/web/components/automations/tower/TowerStepRail/TowerStepRail.spec.ts` (12 lines)  
...
**ANS.** Search imports: `rg "TowerStepRail.spec" apps packages --glob '*.{ts,tsx}'`.
