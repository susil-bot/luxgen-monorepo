...
`apps/web/components/automations/tower/TowerStepRail/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchTowerStepRailData`?"


## Interview Questions

- Walk me through TowerStepRailData line by line.
