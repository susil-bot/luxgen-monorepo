...
**Path:** `apps/web/components/automations/tower/TowerStepRail/styles.ts` (5 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/components/automations/tower/TowerStepRail/styles.ts:3** and read the function body.
