...
**Path:** `apps/web/components/layout/Footer.tsx` (80 lines)  
...
**ANS.** Application module. Main exports: `Footer`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `Footer`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **apps/web/components/layout/Footer.tsx:1** and read the function body.
