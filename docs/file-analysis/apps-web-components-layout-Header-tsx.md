...
**Path:** `apps/web/components/layout/Header.tsx` (51 lines)  
...
**ANS.** Application module. Main exports: `Header`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `Header`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **apps/web/components/layout/Header.tsx:12** and read the function body.
