...
`apps/web/components/layout/RouteProgressBar.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `RouteProgressBar`?"

### `start`

- **Approx. line:** 9
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `start`?"

### `end`

- **Approx. line:** 10
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `end`?"


## Interview Questions

- Walk me through RouteProgressBar line by line.
...
```bash
rg "RouteProgressBar" apps packages --glob '*.{ts,tsx}'
```
