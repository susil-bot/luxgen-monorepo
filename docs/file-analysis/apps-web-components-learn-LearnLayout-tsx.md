...
`apps/web/components/learn/LearnLayout.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `LearnLayout`?"


## Interview Questions

- Walk me through LearnLayout line by line.
...
```bash
rg "LearnLayout" apps packages --glob '*.{ts,tsx}'
```
