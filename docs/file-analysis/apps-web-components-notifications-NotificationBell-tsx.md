...
- **Interview:** "What are inputs, outputs, and side effects of `NotificationPanel`?"


## Interview Questions

- Walk me through NotificationPanel line by line.
...
```bash
rg "NotificationBell" apps packages --glob '*.{ts,tsx}'
```
