# OnboardingWizardStep1.tsx

## File Path

`apps/web/components/onboarding/OnboardingWizardStep1.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `OnboardingWizardStep1`?"

### `markDone`

- **Approx. line:** 62
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `markDone`?"

### `dismiss`

- **Approx. line:** 43
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `dismiss`?"


## Interview Questions

- Walk me through OnboardingStep line by line.
...
```bash
rg "OnboardingWizardStep1" apps packages --glob '*.{ts,tsx}'
```
