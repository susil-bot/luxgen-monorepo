# OrganizationProfilePanel.tsx

## File Path

`apps/web/components/organization/OrganizationProfilePanel.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `OrganizationProfilePanel`?"


## Interview Questions

- Walk me through OrganizationProfilePanel line by line.
...
```bash
rg "OrganizationProfilePanel" apps packages --glob '*.{ts,tsx}'
```
