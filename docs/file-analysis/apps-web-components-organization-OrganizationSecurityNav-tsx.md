# OrganizationSecurityNav.tsx

## File Path

`apps/web/components/organization/OrganizationSecurityNav.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `OrganizationSecurityNav`?"


## Interview Questions

- Walk me through OrganizationSecurityNav line by line.
...
```bash
rg "OrganizationSecurityNav" apps packages --glob '*.{ts,tsx}'
```
