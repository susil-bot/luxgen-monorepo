...
`apps/web/components/project/ProjectCard.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `ProjectCard`?"


## Interview Questions

- Walk me through ProjectCard line by line.
...
```bash
rg "ProjectCard" apps packages --glob '*.{ts,tsx}'
```
