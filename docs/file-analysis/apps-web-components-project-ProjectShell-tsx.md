...
`apps/web/components/project/ProjectShell.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `ProjectShell`?"


## Interview Questions

- Walk me through ProjectTab line by line.
...
```bash
rg "ProjectShell" apps packages --glob '*.{ts,tsx}'
```
