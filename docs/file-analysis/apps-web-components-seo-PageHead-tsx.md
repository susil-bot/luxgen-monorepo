...
- **Interview:** "What are inputs, outputs, and side effects of `PageHead`?"

### `DefaultPageHead`

- **Approx. line:** 82
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `DefaultPageHead`?"


## Interview Questions

- Walk me through PageHeadProps line by line.
...
```bash
rg "PageHead" apps packages --glob '*.{ts,tsx}'
```
