# GptSalesAssistant.tsx

## File Path

`apps/web/components/store/GptSalesAssistant.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `GptSalesAssistant`?"


## Interview Questions

- Walk me through GptSalesAssistant line by line.
...
```bash
rg "GptSalesAssistant" apps packages --glob '*.{ts,tsx}'
```
