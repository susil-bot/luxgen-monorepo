...
`apps/web/components/store/StoreNav.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `StoreNav`?"


## Interview Questions

- Walk me through StoreNav line by line.
...
```bash
rg "StoreNav" apps packages --glob '*.{ts,tsx}'
```
