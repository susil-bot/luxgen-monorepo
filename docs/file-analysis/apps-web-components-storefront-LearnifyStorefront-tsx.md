# LearnifyStorefront.tsx

## File Path

`apps/web/components/storefront/LearnifyStorefront.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `LearnifyStorefront`?"


## Interview Questions

- Walk me through LearnifyStorefront line by line.
...
```bash
rg "LearnifyStorefront" apps packages --glob '*.{ts,tsx}'
```
