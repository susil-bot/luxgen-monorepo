# TenantThemeBridge.tsx

## File Path

`apps/web/components/theme/TenantThemeBridge.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `TenantThemeBridge`?"


## Interview Questions

- How is tenant resolved: subdomain, header, or JWT claim?
- Walk me through TenantThemeBridge line by line.
...
```bash
rg "TenantThemeBridge" apps packages --glob '*.{ts,tsx}'
```
