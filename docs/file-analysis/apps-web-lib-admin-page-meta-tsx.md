...
`apps/web/lib/admin-page-meta.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `AdminPageMeta`?"


## Interview Questions

- Walk me through AdminPageMeta line by line.
...
```bash
rg "admin-page-meta" apps packages --glob '*.{ts,tsx}'
```
