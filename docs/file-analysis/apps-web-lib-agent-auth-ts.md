...
- **Workspace packages:** @luxgen/agent, @luxgen/auth
...
- **Interview:** "What are inputs, outputs, and side effects of `requireAgentAuth`?"

### `requireAgentAdmin`

- **Approx. line:** 21
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `requireAgentAdmin`?"

### `requireAgentStudio`

- **Approx. line:** 43
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `requireAgentStudio`?"


## Interview Questions

- Walk me through requireAgentAuth line by line.
...
```bash
rg "agent-auth" apps packages --glob '*.{ts,tsx}'
```
