# agent.ts — Brief + Junior Q&A

**Path:** `apps/web/lib/agent.ts` (9 lines)  
**Role:** Application module

## Exports

- `SYSTEM_PROMPT` — line 8
...
**ANS.** Exported symbol — open source at **apps/web/lib/agent.ts:8** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "agent" apps packages --glob '*.{ts,tsx}'`.
