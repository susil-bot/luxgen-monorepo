...
`apps/web/lib/automation-map.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `triggerToGql`?"

### `triggerFromGql`

- **Approx. line:** 47
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `triggerFromGql`?"

### `actionToGql`

- **Approx. line:** 51
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `actionToGql`?"

### `actionFromGql`

- **Approx. line:** 55
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `actionFromGql`?"

### `formatRelativeTime`

- **Approx. line:** 59
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `formatRelativeTime`?"

### `formatRunTimestamp`

- **Approx. line:** 71
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `formatRunTimestamp`?"


## Interview Questions

- Walk me through UiTriggerType line by line.
...
```bash
rg "automation-map" apps packages --glob '*.{ts,tsx}'
```
