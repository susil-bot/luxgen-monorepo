...
- **Interview:** "What are inputs, outputs, and side effects of `createDashboardActionHandler`?"


## Interview Questions

- Walk me through createDashboardActionHandler line by line.
...
```bash
rg "dashboard-actions" apps packages --glob '*.{ts,tsx}'
```
