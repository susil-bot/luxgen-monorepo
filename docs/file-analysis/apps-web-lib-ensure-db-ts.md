...
- **Interview:** "What are inputs, outputs, and side effects of `ensureDbConnection`?"


## Interview Questions

- Walk me through ensureDbConnection line by line.
...
```bash
rg "ensure-db" apps packages --glob '*.{ts,tsx}'
```
