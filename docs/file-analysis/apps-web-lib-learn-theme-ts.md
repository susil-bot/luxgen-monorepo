...
- **Interview:** "What are inputs, outputs, and side effects of `applyLearnTenantTheme`?"


## Interview Questions

- Walk me through applyLearnTenantTheme line by line.
...
```bash
rg "learn-theme" apps packages --glob '*.{ts,tsx}'
```
