...
- **Interview:** "What are inputs, outputs, and side effects of `isMongoObjectId`?"


## Interview Questions

- Walk me through isMongoObjectId line by line.
...
```bash
rg "mongo-id" apps packages --glob '*.{ts,tsx}'
```
