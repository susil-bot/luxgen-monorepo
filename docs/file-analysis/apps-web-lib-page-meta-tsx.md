...
- **Interview:** "What are inputs, outputs, and side effects of `PageMeta`?"


## Interview Questions

- Walk me through PageMeta line by line.
...
```bash
rg "page-meta" apps packages --glob '*.{ts,tsx}'
```
