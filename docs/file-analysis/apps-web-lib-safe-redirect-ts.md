...
- **Interview:** "What are inputs, outputs, and side effects of `safeRedirectPath`?"


## Interview Questions

- Walk me through safeRedirectPath line by line.
...
```bash
rg "safe-redirect" apps packages --glob '*.{ts,tsx}'
```
