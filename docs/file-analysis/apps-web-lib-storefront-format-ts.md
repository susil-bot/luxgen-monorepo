...
- **Interview:** "What are inputs, outputs, and side effects of `formatStorefrontPrice`?"

### `formatBillingInterval`

- **Approx. line:** 10
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `formatBillingInterval`?"


## Interview Questions

- Walk me through formatStorefrontPrice line by line.
...
```bash
rg "storefront-format" apps packages --glob '*.{ts,tsx}'
```
