# storefront-settings.ts

## File Path

`apps/web/lib/storefront-settings.ts`
...
- Walk me through DEFAULT_STOREFRONT_ROUTES line by line.
...
```bash
rg "storefront-settings" apps packages --glob '*.{ts,tsx}'
```
