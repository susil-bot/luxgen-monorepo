# 33-mongo-id.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/web/lib/vitest-auto/33-mongo-id.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "33-mongo-id.auto.test" apps packages --glob '*.{ts,tsx}'`.
