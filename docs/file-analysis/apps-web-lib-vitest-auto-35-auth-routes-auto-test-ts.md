# 35-auth-routes.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/web/lib/vitest-auto/35-auth-routes.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "35-auth-routes.auto.test" apps packages --glob '*.{ts,tsx}'`.
