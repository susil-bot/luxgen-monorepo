# 39-auth-notices.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/web/lib/vitest-auto/39-auth-notices.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "39-auth-notices.auto.test" apps packages --glob '*.{ts,tsx}'`.
