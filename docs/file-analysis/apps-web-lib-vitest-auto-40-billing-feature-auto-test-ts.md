# 40-billing-feature.auto.test.ts — Brief + Junior Q&A

**Path:** `apps/web/lib/vitest-auto/40-billing-feature.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "40-billing-feature.auto.test" apps packages --glob '*.{ts,tsx}'`.
