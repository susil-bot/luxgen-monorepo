# apply.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/agent/apply.ts` (49 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/agent/apply.ts:5** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "apply" apps packages --glob '*.{ts,tsx}'`.
