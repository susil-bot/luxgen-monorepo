# audit.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/agent/audit.ts` (24 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/agent/audit.ts:5** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "audit" apps packages --glob '*.{ts,tsx}'`.
