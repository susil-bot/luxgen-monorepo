# commit.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/agent/commit.ts` (89 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/agent/commit.ts:13** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "commit" apps packages --glob '*.{ts,tsx}'`.
