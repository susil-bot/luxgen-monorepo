# merge.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/agent/merge.ts` (45 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/agent/merge.ts:5** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "merge" apps packages --glob '*.{ts,tsx}'`.
