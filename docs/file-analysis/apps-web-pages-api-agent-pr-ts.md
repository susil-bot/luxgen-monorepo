# pr.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/agent/pr.ts` (35 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/agent/pr.ts:5** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "pr" apps packages --glob '*.{ts,tsx}'`.
