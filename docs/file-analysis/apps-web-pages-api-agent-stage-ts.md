# stage.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/agent/stage.ts` (35 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/agent/stage.ts:5** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "stage" apps packages --glob '*.{ts,tsx}'`.
