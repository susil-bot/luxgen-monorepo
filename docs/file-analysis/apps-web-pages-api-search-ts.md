# search.ts — Brief + Junior Q&A

**Path:** `apps/web/pages/api/search.ts` (30 lines)  
...
**ANS.** Exported symbol — open source at **apps/web/pages/api/search.ts:11** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "search" apps packages --glob '*.{ts,tsx}'`.
