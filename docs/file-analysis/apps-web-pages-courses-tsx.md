...
- **Interview:** "What are inputs, outputs, and side effects of `handleNavigate`?"


## Interview Questions

- Walk me through CoursesPage line by line.
...
```bash
rg "courses" apps packages --glob '*.{ts,tsx}'
```
