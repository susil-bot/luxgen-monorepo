...
- `../components/dashboard/DashboardBanner`
- `../components/onboarding/OnboardingWizardStep1`
...
- **Interview:** "What are inputs, outputs, and side effects of `onUserAction`?"


## Interview Questions

- Walk me through Dashboard line by line.
