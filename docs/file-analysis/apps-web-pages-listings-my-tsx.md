...
`apps/web/pages/listings/my.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `pay`?"
...
- Walk me through MyListingsPage line by line.
...
```bash
rg "my" apps packages --glob '*.{ts,tsx}'
```
