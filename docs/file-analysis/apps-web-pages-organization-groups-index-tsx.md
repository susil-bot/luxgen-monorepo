...
`apps/web/pages/organization/groups/index.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `GroupsIcon`?"
...
- Walk me through OrganizationGroupsPage line by line.
