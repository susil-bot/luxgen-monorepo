...
`apps/web/pages/organization/security/domains.tsx`
...
- `OrganizationSecurityDomainsPage`
- `getServerSideProps`
- `default`
...
- Walk me through OrganizationSecurityDomainsPage line by line.
...
```bash
rg "domains" apps packages --glob '*.{ts,tsx}'
```
