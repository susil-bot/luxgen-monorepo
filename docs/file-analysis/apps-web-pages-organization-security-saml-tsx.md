...
`apps/web/pages/organization/security/saml.tsx`
...
- Walk me through OrganizationSecuritySamlPage line by line.
...
```bash
rg "saml" apps packages --glob '*.{ts,tsx}'
```
