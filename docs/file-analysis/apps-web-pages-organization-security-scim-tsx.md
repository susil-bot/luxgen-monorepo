...
`apps/web/pages/organization/security/scim.tsx`
...
- Walk me through OrganizationSecurityScimPage line by line.
...
```bash
rg "scim" apps packages --glob '*.{ts,tsx}'
```
