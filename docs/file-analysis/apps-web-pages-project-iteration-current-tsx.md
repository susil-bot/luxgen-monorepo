...
`apps/web/pages/project/iteration/current.tsx`
...
- `../../../components/project/IterationBoard`
...
- **Interview:** "What are inputs, outputs, and side effects of `closeNew`?"
...
- Walk me through CurrentIterationPage line by line.
...
```bash
rg "current" apps packages --glob '*.{ts,tsx}'
```
