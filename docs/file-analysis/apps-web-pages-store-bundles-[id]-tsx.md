...
`apps/web/pages/store/bundles/[id].tsx`
...
- `../../../lib/use-storefront-subscribe`
- `../../../components/store/CheckoutSteps`


## Exports

- `StoreBundleDetailPage`
- `getServerSideProps`
- `default`
...
- Walk me through StoreBundleDetailPage line by line.
