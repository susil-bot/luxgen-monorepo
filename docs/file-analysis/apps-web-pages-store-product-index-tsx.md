...
`apps/web/pages/store/product/index.tsx`
...
- `next/router`
- `@apollo/client`
- `../../../components/store/CategoryRail`
- `../../../components/store/StorefrontProductCard`
...
- Walk me through StoreProductPage line by line.
