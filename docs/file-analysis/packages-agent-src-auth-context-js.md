# context.js — Brief + Junior Q&A

**Path:** `packages/agent/src/auth/context.js` (57 lines)  
...
**ANS.** See **packages/agent/src/auth/context.js:17** — check parameters, return value, and side effects.
