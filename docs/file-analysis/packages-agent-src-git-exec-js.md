# exec.js — Brief + Junior Q&A

**Path:** `packages/agent/src/git/exec.js` (66 lines)  
...
**ANS.** See **packages/agent/src/git/exec.js:18** — check parameters, return value, and side effects.
