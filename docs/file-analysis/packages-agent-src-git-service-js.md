...
`packages/agent/src/git/service.js`
...
- **Interview:** "What are inputs, outputs, and side effects of `config`?"
...
- **Approx. line:** 45
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `branch`?"

### `worktreePath`

- **Approx. line:** 46
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `worktreePath`?"

### `worktreesDir`

- **Approx. line:** 53
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `worktreesDir`?"


## Interview Questions

- Why is this file side-effect only?
- Walk me through service.js line by line.
