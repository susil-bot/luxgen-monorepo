# service.js — Brief + Junior Q&A

**Path:** `packages/agent/src/git/service.js` (336 lines)  
...
--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What does `config` do?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** See **packages/agent/src/git/service.js:36** — check parameters, return value, and side effects.
