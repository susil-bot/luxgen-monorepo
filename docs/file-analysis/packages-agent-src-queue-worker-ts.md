...
- **Interview:** "What are inputs, outputs, and side effects of `processHeadlessJob`?"

### `runWorkerLoop`

- **Approx. line:** 163
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `runWorkerLoop`?"

### `shutdownWorker`

- **Approx. line:** 206
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `shutdownWorker`?"


## Interview Questions

- Walk me through processHeadlessJob line by line.
