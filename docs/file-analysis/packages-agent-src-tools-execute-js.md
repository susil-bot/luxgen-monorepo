# execute.js — Brief + Junior Q&A

**Path:** `packages/agent/src/tools/execute.js` (149 lines)  
...
**ANS.** See **packages/agent/src/tools/execute.js:67** — check parameters, return value, and side effects.
