# pipeline.js — Brief + Junior Q&A

**Path:** `packages/agent/src/validation/pipeline.js` (156 lines)  
...
--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What does `execFileAsync` do?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** See **packages/agent/src/validation/pipeline.js:9** — check parameters, return value, and side effects.
