# policy.js — Brief + Junior Q&A

**Path:** `packages/agent/src/validation/policy.js` (19 lines)  
...
**ANS.** See **packages/agent/src/validation/policy.js:7** — check parameters, return value, and side effects.
