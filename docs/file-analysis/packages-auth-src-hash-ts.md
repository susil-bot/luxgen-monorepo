...
- **Interview:** "What are inputs, outputs, and side effects of `hashPassword`?"

### `verifyPassword`

- **Approx. line:** 9
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `verifyPassword`?"


## Interview Questions

- Walk me through hashPassword line by line.
...
```bash
rg "hash" apps packages --glob '*.{ts,tsx}'
```
