...
`packages/automation-flow/src/catalog/index.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `getFlowCompound`?"

### `listFlowCompounds`

- **Approx. line:** 10
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `listFlowCompounds`?"

### `exportAutomationSchema`

- **Approx. line:** 15
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `exportAutomationSchema`?"


## Interview Questions

- Walk me through getFlowCompound line by line.
