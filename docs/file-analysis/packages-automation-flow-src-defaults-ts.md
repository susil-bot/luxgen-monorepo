...
`packages/automation-flow/src/defaults.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `createOrderCreatedFlow`?"

### `createEmptyFlow`

- **Approx. line:** 68
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `createEmptyFlow`?"

### `flowNodeToStepView`

- **Approx. line:** 87
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `flowNodeToStepView`?"

### `flowToOrderedSteps`

- **Approx. line:** 101
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `flowToOrderedSteps`?"

### `flowToLegacyAutomation`

- **Approx. line:** 126
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `flowToLegacyAutomation`?"


## Interview Questions

- Walk me through createOrderCreatedFlow line by line.
