...
`packages/automation-flow/src/validate.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `validateTowerFlowDocument`?"

### `parseTowerFlowDocument`

- **Approx. line:** 141
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `parseTowerFlowDocument`?"

### `collectTowerFlowGraphWarnings`

- **Approx. line:** 163
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `collectTowerFlowGraphWarnings`?"


## Interview Questions

- Walk me through validateTowerFlowDocument line by line.
...
```bash
rg "validate" apps packages --glob '*.{ts,tsx}'
```
