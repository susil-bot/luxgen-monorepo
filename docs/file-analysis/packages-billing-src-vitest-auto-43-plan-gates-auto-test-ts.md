# 43-plan-gates.auto.test.ts — Brief + Junior Q&A

**Path:** `packages/billing/src/vitest-auto/43-plan-gates.auto.test.ts` (9 lines)  
...
**ANS.** Search imports: `rg "43-plan-gates.auto.test" apps packages --glob '*.{ts,tsx}'`.
