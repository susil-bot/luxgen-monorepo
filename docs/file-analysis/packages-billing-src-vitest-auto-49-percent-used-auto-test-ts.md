# 49-percent-used.auto.test.ts — Brief + Junior Q&A

**Path:** `packages/billing/src/vitest-auto/49-percent-used.auto.test.ts` (10 lines)  
...
**ANS.** Search imports: `rg "49-percent-used.auto.test" apps packages --glob '*.{ts,tsx}'`.
