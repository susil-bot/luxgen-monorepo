...
`packages/core/src/plugin/Presenter.ts`
...
- `Presenter`
- `createArticlePresenter`
- `createBundlePresenter`
- `createSearchPresenter`
- `createCollectionPresenter`
...
- **Interview:** "What are inputs, outputs, and side effects of `createArticlePresenter`?"

### `createBundlePresenter`

- **Approx. line:** 125
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `createBundlePresenter`?"

### `createSearchPresenter`

- **Approx. line:** 144
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `createSearchPresenter`?"

### `createCollectionPresenter`

- **Approx. line:** 163
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `createCollectionPresenter`?"


## Interview Questions

- Walk me through Presenter line by line.
...
```bash
rg "Presenter" apps packages --glob '*.{ts,tsx}'
```
