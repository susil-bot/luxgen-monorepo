...
- **Interview:** "What are inputs, outputs, and side effects of `connectDB`?"

### `disconnectDB`

- **Approx. line:** 17
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `disconnectDB`?"


## Interview Questions

- Walk me through connectDB line by line.
...
```bash
rg "connection" apps packages --glob '*.{ts,tsx}'
```
