...
- **Interview:** "What are inputs, outputs, and side effects of `enrollmentSubjectId`?"


## Interview Questions

- Walk me through EnrollmentPaymentStatus line by line.
