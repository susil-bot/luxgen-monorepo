# learner-subscription.ts

## File Path

`packages/db/src/learner-subscription.ts`
...
- Walk me through LearnerSubscriptionStatus line by line.
...
```bash
rg "learner-subscription" apps packages --glob '*.{ts,tsx}'
```
