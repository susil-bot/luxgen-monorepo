...
`packages/db/src/tenant-billing.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `resolveEffectivePlan`?"


## Interview Questions

- How is tenant resolved: subdomain, header, or JWT claim?
- Walk me through resolveEffectivePlan line by line.
