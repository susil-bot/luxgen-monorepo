...
`packages/db/src/tenant-config/idea-vibes/tenant.ts`
...
- `IdeaVibesTenantDocument`
- `IdeaVibesTenant`
- `ideaVibesTenantOperations`
...
- Walk me through IdeaVibesTenantDocument line by line.
