...
- **Interview:** "What are inputs, outputs, and side effects of `currentUsagePeriod`?"


## Interview Questions

- Walk me through ITenantUsageMonthly line by line.
...
```bash
rg "usage" apps packages --glob '*.{ts,tsx}'
```
