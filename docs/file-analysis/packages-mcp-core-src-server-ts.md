...
- **Interview:** "What are inputs, outputs, and side effects of `createLuxgenMcpServer`?"


## Interview Questions

- Walk me through createLuxgenMcpServer line by line.
...
```bash
rg "server" apps packages --glob '*.{ts,tsx}'
```
