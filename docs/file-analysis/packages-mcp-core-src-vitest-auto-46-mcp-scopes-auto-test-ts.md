# 46-mcp-scopes.auto.test.ts — Brief + Junior Q&A

**Path:** `packages/mcp-core/src/vitest-auto/46-mcp-scopes.auto.test.ts` (11 lines)  
...
**ANS.** Search imports: `rg "46-mcp-scopes.auto.test" apps packages --glob '*.{ts,tsx}'`.
