# 47-rate-limit.auto.test.ts — Brief + Junior Q&A

**Path:** `packages/mcp-core/src/vitest-auto/47-rate-limit.auto.test.ts` (11 lines)  
...
**ANS.** Search imports: `rg "47-rate-limit.auto.test" apps packages --glob '*.{ts,tsx}'`.
