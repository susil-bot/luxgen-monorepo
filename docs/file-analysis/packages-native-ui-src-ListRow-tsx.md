...
`packages/native-ui/src/ListRow.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `ListRow`?"


## Interview Questions

- Walk me through ListRowProps line by line.
...
```bash
rg "ListRow" apps packages --glob '*.{ts,tsx}'
```
