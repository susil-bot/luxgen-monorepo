...
`packages/storefront/src/presets/index.ts`
...
- `getTenantStorefrontPreset`
- `demoStorefrontPreset`
- `ideaVibesStorefrontPreset`
...
- **Interview:** "What are inputs, outputs, and side effects of `getTenantStorefrontPreset`?"


## Interview Questions

- Walk me through getTenantStorefrontPreset line by line.
