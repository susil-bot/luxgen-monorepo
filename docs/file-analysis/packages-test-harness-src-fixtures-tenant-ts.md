...
`packages/test-harness/src/fixtures/tenant.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `mockTenant`?"


## Interview Questions

- How is tenant resolved: subdomain, header, or JWT claim?
- Walk me through mockTenant line by line.
...
- **Why this way?** Colocated with feature domain (`packages/test-harness/src`).
