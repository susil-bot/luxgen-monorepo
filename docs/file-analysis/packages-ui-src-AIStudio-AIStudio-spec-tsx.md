# AIStudio.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/AIStudio/AIStudio.spec.tsx` (28 lines)  
...
**ANS.** Search imports: `rg "AIStudio.spec" apps packages --glob '*.{ts,tsx}'`.
