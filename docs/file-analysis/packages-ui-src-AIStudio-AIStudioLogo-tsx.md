...
`packages/ui/src/AIStudio/AIStudioLogo.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `AIStudioLogo`?"


## Interview Questions

- Walk me through AIStudioLogoProps line by line.
...
```bash
rg "AIStudioLogo" apps packages --glob '*.{ts,tsx}'
```
