# AIStudioPanelSlot.tsx

## File Path

`packages/ui/src/AIStudio/AIStudioPanelSlot.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `AIStudioPanelSlot`?"


## Interview Questions

- Walk me through AIStudioPanelSlot line by line.
...
```bash
rg "AIStudioPanelSlot" apps packages --glob '*.{ts,tsx}'
```
