...
`packages/ui/src/AIStudio/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchAIStudioData`?"

### `fetchAIStudioSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchAIStudioSSR`?"


## Interview Questions

- Walk me through AIStudioData line by line.
