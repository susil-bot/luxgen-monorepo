...
**Path:** `packages/ui/src/AIStudio/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `aiStudioStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `aiStudioStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `aiStudioStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/AIStudio/styles.ts:3** and read the function body.
