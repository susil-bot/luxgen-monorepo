# Accordion.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Accordion/Accordion.spec.tsx` (167 lines)  
...
**ANS.** Search imports: `rg "Accordion.spec" apps packages --glob '*.{ts,tsx}'`.
