...
`packages/ui/src/Accordion/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchAccordionData`?"

### `fetchAccordionSSR`

- **Approx. line:** 56
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchAccordionSSR`?"


## Interview Questions

- Walk me through AccordionData line by line.
