...
**Path:** `packages/ui/src/Accordion/styles.ts` (268 lines)  
**Role:** Shared UI component or hook

## Exports

- `accordionStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `accordionStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `accordionStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Accordion/styles.ts:3** and read the function body.
