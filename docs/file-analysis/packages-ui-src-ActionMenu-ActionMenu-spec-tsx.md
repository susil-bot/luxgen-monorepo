# ActionMenu.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/ActionMenu/ActionMenu.spec.tsx` (94 lines)  
...
**ANS.** Search imports: `rg "ActionMenu.spec" apps packages --glob '*.{ts,tsx}'`.
