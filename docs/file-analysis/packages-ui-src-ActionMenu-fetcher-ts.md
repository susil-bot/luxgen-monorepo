...
`packages/ui/src/ActionMenu/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchActionMenuData`?"

### `fetchActionMenuSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchActionMenuSSR`?"


## Interview Questions

- Walk me through ActionMenuData line by line.
