...
**Path:** `packages/ui/src/ActionMenu/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `actionMenuStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `actionMenuStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `actionMenuStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ActionMenu/styles.ts:3** and read the function body.
