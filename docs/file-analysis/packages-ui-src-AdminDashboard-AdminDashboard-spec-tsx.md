# AdminDashboard.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/AdminDashboard/AdminDashboard.spec.tsx` (26 lines)  
...
**ANS.** Search imports: `rg "AdminDashboard.spec" apps packages --glob '*.{ts,tsx}'`.
