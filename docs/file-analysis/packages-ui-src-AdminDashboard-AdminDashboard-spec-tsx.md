...
`packages/ui/src/AdminDashboard/AdminDashboard.spec.tsx`
...
- Walk me through AdminDashboard.spec.tsx line by line.
...
```bash
rg "AdminDashboard.spec" apps packages --glob '*.{ts,tsx}'
```
