...
`packages/ui/src/AdminDashboard/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchAdminDashboardData`?"

### `fetchAdminDashboardSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchAdminDashboardSSR`?"


## Interview Questions

- Walk me through AdminDashboardData line by line.
