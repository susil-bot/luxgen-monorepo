...
`packages/ui/src/AdminDashboard/styles.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `getAdminDashboardStyles`?"


## Interview Questions

- Walk me through getAdminDashboardStyles line by line.
