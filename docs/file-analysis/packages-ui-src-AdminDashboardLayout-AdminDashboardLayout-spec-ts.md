# AdminDashboardLayout.spec.ts — Brief + Junior Q&A

**Path:** `packages/ui/src/AdminDashboardLayout/AdminDashboardLayout.spec.ts` (9 lines)  
...
**ANS.** Search imports: `rg "AdminDashboardLayout.spec" apps packages --glob '*.{ts,tsx}'`.
