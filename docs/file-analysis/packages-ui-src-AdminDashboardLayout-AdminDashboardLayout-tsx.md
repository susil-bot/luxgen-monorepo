...
`packages/ui/src/AdminDashboardLayout/AdminDashboardLayout.tsx`
...
- `../Layout/DefaultNavigation`
- `./styles`
- `../AdminDashboard/dashboard-actions`
...
- Walk me through AdminDashboardLayoutProps line by line.
...
```bash
rg "AdminDashboardLayout" apps packages --glob '*.{ts,tsx}'
```
