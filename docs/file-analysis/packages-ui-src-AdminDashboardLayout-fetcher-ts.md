...
`packages/ui/src/AdminDashboardLayout/fetcher.ts`
...
- `AdminDashboardLayoutData`
- `fetchAdminDashboardLayoutData`
- `fetchAdminDashboardLayoutSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchAdminDashboardLayoutData`?"

### `fetchAdminDashboardLayoutSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchAdminDashboardLayoutSSR`?"


## Interview Questions

- Walk me through AdminDashboardLayoutData line by line.
