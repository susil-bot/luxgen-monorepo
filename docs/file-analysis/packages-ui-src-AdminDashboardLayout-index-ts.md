...
`packages/ui/src/AdminDashboardLayout/index.ts`
...
- `adminDashboardLayoutFixtures`
- `adminDashboardLayoutStyles`
- `AdminDashboardLayoutTranslations`
...
- Walk me through AdminDashboardLayout line by line.
