...
`packages/ui/src/AdminDashboardLayout/styles.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `getAdminDashboardLayoutStyles`?"


## Interview Questions

- Walk me through getAdminDashboardLayoutStyles line by line.
