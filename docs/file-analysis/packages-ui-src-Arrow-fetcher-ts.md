...
`packages/ui/src/Arrow/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchArrowData`?"

### `fetchArrowSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchArrowSSR`?"


## Interview Questions

- Walk me through ArrowData line by line.
