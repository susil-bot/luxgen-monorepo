...
`packages/ui/src/Arrow/styles.ts`
...
- **Approx. line:** 69
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getDirectionStyles`?"

### `getArrowStyles`

- **Approx. line:** 79
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getArrowStyles`?"

### `getArrowConfig`

- **Approx. line:** 155
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getArrowConfig`?"


## Interview Questions

- Walk me through ArrowStyles line by line.
