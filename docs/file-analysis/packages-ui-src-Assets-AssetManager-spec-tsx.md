# AssetManager.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Assets/AssetManager.spec.tsx` (275 lines)  
...
**ANS.** Search imports: `rg "AssetManager.spec" apps packages --glob '*.{ts,tsx}'`.
