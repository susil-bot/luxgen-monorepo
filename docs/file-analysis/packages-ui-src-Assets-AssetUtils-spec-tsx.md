# AssetUtils.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Assets/AssetUtils.spec.tsx` (328 lines)  
...
**ANS.** Search imports: `rg "AssetUtils.spec" apps packages --glob '*.{ts,tsx}'`.
