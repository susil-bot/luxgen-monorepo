# DefaultBrandAssets.ts

## File Path

`packages/ui/src/Assets/DefaultBrandAssets.ts`
...
- `luxgenBrandAssets`
- `demoBrandAssets`
- `ideaVibesBrandAssets`
- `defaultAssets`
- `brandAssetsByTenant`
- `getBrandAssetsForTenant`
...
- **Interview:** "What are inputs, outputs, and side effects of `getBrandAssetsForTenant`?"


## Interview Questions

- Walk me through luxgenBrandAssets line by line.
...
```bash
rg "DefaultBrandAssets" apps packages --glob '*.{ts,tsx}'
```
