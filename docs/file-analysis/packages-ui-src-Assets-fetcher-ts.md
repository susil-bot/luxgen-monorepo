...
`packages/ui/src/Assets/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchAssetsData`?"

### `fetchAssetsSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchAssetsSSR`?"


## Interview Questions

- Walk me through AssetsData line by line.
