...
`packages/ui/src/Badge/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchBadgeData`?"

### `fetchBadgeSSR`

- **Approx. line:** 28
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchBadgeSSR`?"


## Interview Questions

- Walk me through BadgeData line by line.
