# BannerCarousel.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/BannerCarousel/BannerCarousel.spec.tsx` (45 lines)  
...
**ANS.** Search imports: `rg "BannerCarousel.spec" apps packages --glob '*.{ts,tsx}'`.
