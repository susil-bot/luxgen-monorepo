...
`packages/ui/src/BannerCarousel/BannerCarousel.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `pause`?"

### `resume`

- **Approx. line:** 51
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `resume`?"
...
- **Approx. line:** 75
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `goToPrevious`?"

### `goToNext`

- **Approx. line:** 80
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `goToNext`?"

### `newIndex`

- **Approx. line:** 76
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `newIndex`?"
...
- Walk me through BannerSlide line by line.
...
```bash
rg "BannerCarousel" apps packages --glob '*.{ts,tsx}'
```
