...
`packages/ui/src/BannerCarousel/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchBannerCarouselData`?"

### `fetchBannerCarouselSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchBannerCarouselSSR`?"


## Interview Questions

- Walk me through BannerCarouselData line by line.
