...
`packages/ui/src/Button/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchButtonData`?"

### `fetchButtonSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchButtonSSR`?"


## Interview Questions

- Walk me through ButtonData line by line.
