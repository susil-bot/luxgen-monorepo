...
`packages/ui/src/Button/utils.js`
...
- **Interview:** "What are inputs, outputs, and side effects of `getStylesForState`?"

### `getButtonColors`

- **Approx. line:** 41
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getButtonColors`?"

### `snowplowClickHandler`

- **Approx. line:** 68
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `snowplowClickHandler`?"


## Interview Questions

- Why is this file side-effect only?
- Walk me through utils.js line by line.
...
```bash
rg "utils" apps packages --glob '*.{ts,tsx}'
```
