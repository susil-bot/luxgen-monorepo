...
`packages/ui/src/Card/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchCardData`?"

### `fetchCardSSR`

- **Approx. line:** 40
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchCardSSR`?"


## Interview Questions

- Walk me through CardData line by line.
