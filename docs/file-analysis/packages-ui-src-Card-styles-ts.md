...
**Path:** `packages/ui/src/Card/styles.ts` (302 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `cardStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `cardStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Card/styles.ts:3** and read the function body.
