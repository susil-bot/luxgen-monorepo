# Carousel.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Carousel/Carousel.spec.tsx` (137 lines)  
...
**ANS.** Search imports: `rg "Carousel.spec" apps packages --glob '*.{ts,tsx}'`.
