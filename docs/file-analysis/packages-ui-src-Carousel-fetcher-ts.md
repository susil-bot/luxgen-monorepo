...
`packages/ui/src/Carousel/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchCarouselData`?"

### `fetchCarouselSSR`

- **Approx. line:** 56
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchCarouselSSR`?"


## Interview Questions

- Walk me through CarouselData line by line.
