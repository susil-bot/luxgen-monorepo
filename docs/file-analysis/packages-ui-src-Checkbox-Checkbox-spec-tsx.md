# Checkbox.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Checkbox/Checkbox.spec.tsx` (111 lines)  
...
**ANS.** Search imports: `rg "Checkbox.spec" apps packages --glob '*.{ts,tsx}'`.
