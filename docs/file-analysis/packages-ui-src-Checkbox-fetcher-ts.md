...
`packages/ui/src/Checkbox/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchCheckboxData`?"

### `fetchCheckboxSSR`

- **Approx. line:** 22
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchCheckboxSSR`?"


## Interview Questions

- Walk me through CheckboxData line by line.
