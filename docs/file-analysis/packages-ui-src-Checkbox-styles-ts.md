...
**Path:** `packages/ui/src/Checkbox/styles.ts` (254 lines)  
**Role:** Shared UI component or hook

## Exports

- `checkboxStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `checkboxStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `checkboxStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Checkbox/styles.ts:3** and read the function body.
