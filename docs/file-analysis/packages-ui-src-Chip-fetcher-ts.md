...
`packages/ui/src/Chip/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchChipData`?"

### `fetchChipSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchChipSSR`?"


## Interview Questions

- Walk me through ChipData line by line.
