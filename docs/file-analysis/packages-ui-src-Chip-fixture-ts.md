...
**Path:** `packages/ui/src/Chip/fixture.ts` (8 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `chipFixtures`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `chipFixtures`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Chip/fixture.ts:3** and read the function body.
