...
**Path:** `packages/ui/src/Chip/styles.ts` (11 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `chipStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `chipStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Chip/styles.ts:3** and read the function body.
