# CountryLanguageDropdown.example.tsx

## File Path

`packages/ui/src/CountryLanguageDropdown/CountryLanguageDropdown.example.tsx`
...
- `CountryLanguageDropdownExample`
...
- **Interview:** "What are inputs, outputs, and side effects of `handleCountryChange`?"

### `handleLanguageChange`

- **Approx. line:** 22
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleLanguageChange`?"


## Interview Questions

- Walk me through CountryLanguageDropdownExample line by line.
...
```bash
rg "CountryLanguageDropdown.example" apps packages --glob '*.{ts,tsx}'
```
