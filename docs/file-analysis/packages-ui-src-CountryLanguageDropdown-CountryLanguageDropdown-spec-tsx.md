# CountryLanguageDropdown.spec.tsx

## File Path

`packages/ui/src/CountryLanguageDropdown/CountryLanguageDropdown.spec.tsx`
...
- Walk me through CountryLanguageDropdown.spec.tsx line by line.
...
```bash
rg "CountryLanguageDropdown.spec" apps packages --glob '*.{ts,tsx}'
```
