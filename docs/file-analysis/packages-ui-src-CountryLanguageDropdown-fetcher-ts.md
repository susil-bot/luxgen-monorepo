...
`packages/ui/src/CountryLanguageDropdown/fetcher.ts`
...
- `CountryLanguageDropdownData`
- `fetchCountryLanguageDropdownData`
- `fetchCountryLanguageDropdownSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchCountryLanguageDropdownData`?"

### `fetchCountryLanguageDropdownSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchCountryLanguageDropdownSSR`?"


## Interview Questions

- Walk me through CountryLanguageDropdownData line by line.
