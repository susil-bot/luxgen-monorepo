# CourseDetailMenu.tsx

## File Path

`packages/ui/src/CourseMenu/CourseDetailMenu.tsx`
...
- **Approx. line:** 30
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `isActive`?"


## Interview Questions

- Walk me through CourseDetailMenu line by line.
...
```bash
rg "CourseDetailMenu" apps packages --glob '*.{ts,tsx}'
```
