# CourseMenu.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/CourseMenu/CourseMenu.spec.tsx` (46 lines)  
...
**ANS.** Search imports: `rg "CourseMenu.spec" apps packages --glob '*.{ts,tsx}'`.
