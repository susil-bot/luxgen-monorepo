...
`packages/ui/src/CourseMenu/CourseMenu.tsx`
...
- **Approx. line:** 15
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getFilteredSections`?"

### `getFilteredItems`

- **Approx. line:** 19
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getFilteredItems`?"


## Interview Questions

- Walk me through CourseMenu line by line.
...
```bash
rg "CourseMenu" apps packages --glob '*.{ts,tsx}'
```
