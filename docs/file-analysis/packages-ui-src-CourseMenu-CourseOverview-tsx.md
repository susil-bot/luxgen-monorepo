...
`packages/ui/src/CourseMenu/CourseOverview.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `renderActionButton`?"

### `renderManagementActions`

- **Approx. line:** 20
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `renderManagementActions`?"


## Interview Questions

- Walk me through CourseOverview line by line.
...
```bash
rg "CourseOverview" apps packages --glob '*.{ts,tsx}'
```
