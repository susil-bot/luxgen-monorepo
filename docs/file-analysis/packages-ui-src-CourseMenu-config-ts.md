...
`packages/ui/src/CourseMenu/config.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `getCourseDetailMenu`?"

### `getCourseManagementMenu`

- **Approx. line:** 176
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getCourseManagementMenu`?"

### `getMenuItemsForRole`

- **Approx. line:** 264
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getMenuItemsForRole`?"

### `hasAccessToMenuItem`

- **Approx. line:** 277
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `hasAccessToMenuItem`?"


## Interview Questions

- Walk me through courseMenuSections line by line.
