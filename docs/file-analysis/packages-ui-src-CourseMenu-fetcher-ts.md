...
`packages/ui/src/CourseMenu/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchCourseMenuData`?"

### `fetchCourseMenuSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchCourseMenuSSR`?"


## Interview Questions

- Walk me through CourseMenuData line by line.
