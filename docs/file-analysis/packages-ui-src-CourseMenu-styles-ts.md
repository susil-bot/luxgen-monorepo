...
**Path:** `packages/ui/src/CourseMenu/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `courseMenuStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `courseMenuStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `courseMenuStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/CourseMenu/styles.ts:3** and read the function body.
