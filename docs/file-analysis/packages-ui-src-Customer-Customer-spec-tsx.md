# Customer.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Customer/Customer.spec.tsx` (160 lines)  
...
**ANS.** Search imports: `rg "Customer.spec" apps packages --glob '*.{ts,tsx}'`.
