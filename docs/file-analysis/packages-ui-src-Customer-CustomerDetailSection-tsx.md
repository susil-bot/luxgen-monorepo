...
`packages/ui/src/Customer/CustomerDetailSection.tsx`
...
- Walk me through CustomerDetailSection line by line.
...
```bash
rg "CustomerDetailSection" apps packages --glob '*.{ts,tsx}'
```
