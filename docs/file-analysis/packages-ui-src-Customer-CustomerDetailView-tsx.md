...
`packages/ui/src/Customer/CustomerDetailView.tsx`
...
- `./CustomerStatsBar`
- `./detail/LastOrderSection`
- `./detail/MetafieldsSection`
- `./detail/CustomerHistorySection`
- `./detail/CustomerContactSection`
- `./detail/MarketingSection`
- `./detail/TaxDetailsSection/TaxDetailsSection`
- `./detail/StoreCreditSection`
- `./detail/CustomerTagsSection`
- `./detail/CustomerNotesSection`
...
- **Interview:** "What are inputs, outputs, and side effects of `CustomerDetailView`?"


## Interview Questions

- Walk me through CustomerDetailViewProps line by line.
...
```bash
rg "CustomerDetailView" apps packages --glob '*.{ts,tsx}'
```
