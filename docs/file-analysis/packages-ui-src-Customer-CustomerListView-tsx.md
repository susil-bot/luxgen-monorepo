...
`packages/ui/src/Customer/CustomerListView.tsx`
...
- `./fetcher`
- `./list/CustomerListTabs/fetcher`
- `./list/CustomerListTable`
- `./translations`
- `../DataList`
- `../DataList`
...
- **Interview:** "What are inputs, outputs, and side effects of `CustomerListView`?"
...
- Walk me through CustomerListViewProps line by line.
...
```bash
rg "CustomerListView" apps packages --glob '*.{ts,tsx}'
```
