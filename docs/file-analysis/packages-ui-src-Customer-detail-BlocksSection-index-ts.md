...
**Path:** `packages/ui/src/Customer/detail/BlocksSection/index.ts` (2 lines)  
**Role:** Shared UI component or hook

## Exports

- `CustomerBlocksSection` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `CustomerBlocksSection`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `CustomerBlocksSection`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Customer/detail/BlocksSection/index.ts:1** and read the function body.
