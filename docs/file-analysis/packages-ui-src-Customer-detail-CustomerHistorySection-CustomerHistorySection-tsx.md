# CustomerHistorySection.tsx

## File Path

`packages/ui/src/Customer/detail/CustomerHistorySection/CustomerHistorySection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `CustomerHistorySection`?"


## Interview Questions

- Walk me through CustomerHistorySectionProps line by line.
...
```bash
rg "CustomerHistorySection" apps packages --glob '*.{ts,tsx}'
```
