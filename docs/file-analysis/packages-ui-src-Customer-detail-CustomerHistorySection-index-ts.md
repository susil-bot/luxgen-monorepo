...
**Path:** `packages/ui/src/Customer/detail/CustomerHistorySection/index.ts` (2 lines)  
**Role:** Shared UI component or hook

## Exports

- `CustomerHistorySection` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `CustomerHistorySection`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `CustomerHistorySection`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Customer/detail/CustomerHistorySection/index.ts:1** and read the function body.
