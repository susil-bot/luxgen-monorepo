...
**Path:** `packages/ui/src/Customer/detail/CustomerNotesSection/index.ts` (2 lines)  
**Role:** Shared UI component or hook

## Exports

- `CustomerNotesSection` — line 1
...
**ANS.** Exported symbol — open source at **packages/ui/src/Customer/detail/CustomerNotesSection/index.ts:1** and read the function body.
