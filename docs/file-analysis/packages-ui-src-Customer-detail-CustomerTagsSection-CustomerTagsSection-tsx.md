# CustomerTagsSection.tsx

## File Path

`packages/ui/src/Customer/detail/CustomerTagsSection/CustomerTagsSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `CustomerTagsSection`?"


## Interview Questions

- Walk me through CustomerTagsSection line by line.
...
```bash
rg "CustomerTagsSection" apps packages --glob '*.{ts,tsx}'
```
