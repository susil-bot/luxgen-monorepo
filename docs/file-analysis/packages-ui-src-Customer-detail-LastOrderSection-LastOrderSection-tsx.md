# LastOrderSection.tsx

## File Path

`packages/ui/src/Customer/detail/LastOrderSection/LastOrderSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `LastOrderSection`?"


## Interview Questions

- Walk me through LastOrderSection line by line.
...
```bash
rg "LastOrderSection" apps packages --glob '*.{ts,tsx}'
```
