...
**Path:** `packages/ui/src/Customer/detail/LastOrderSection/index.ts` (2 lines)  
**Role:** Shared UI component or hook

## Exports

- `LastOrderSection` — line 1
...
**ANS.** Exported symbol — open source at **packages/ui/src/Customer/detail/LastOrderSection/index.ts:1** and read the function body.
