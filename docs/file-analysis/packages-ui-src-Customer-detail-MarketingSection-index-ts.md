...
**Path:** `packages/ui/src/Customer/detail/MarketingSection/index.ts` (2 lines)  
**Role:** Shared UI component or hook

## Exports

- `MarketingSection` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `MarketingSection`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `MarketingSection`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Customer/detail/MarketingSection/index.ts:1** and read the function body.
