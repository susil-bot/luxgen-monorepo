# TaxDetailsSection.tsx

## File Path

`packages/ui/src/Customer/detail/TaxDetailsSection/TaxDetailsSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `TaxDetailsSection`?"


## Interview Questions

- Walk me through TaxDetailsSection line by line.
...
```bash
rg "TaxDetailsSection" apps packages --glob '*.{ts,tsx}'
```
