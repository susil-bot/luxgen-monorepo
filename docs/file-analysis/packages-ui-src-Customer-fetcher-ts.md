...
`packages/ui/src/Customer/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `buildCustomersFromUsers`?"

### `filterCustomersByTab`

- **Approx. line:** 109
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `filterCustomersByTab`?"

### `buildCustomerDetail`

- **Approx. line:** 134
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `buildCustomerDetail`?"

### `findCustomerDetail`

- **Approx. line:** 181
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `findCustomerDetail`?"

### `buildCustomerDetailFromUser`

- **Approx. line:** 195
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `buildCustomerDetailFromUser`?"

### `formatCustomerListDate`

- **Approx. line:** 226
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `formatCustomerListDate`?"


## Interview Questions

- Walk me through CustomerFilterTab line by line.
