...
**Path:** `packages/ui/src/Customer/list/CustomerListTable/index.ts` (3 lines)  
**Role:** Shared UI component or hook

## Exports

- `CustomerListTable` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `CustomerListTable`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `CustomerListTable`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Customer/list/CustomerListTable/index.ts:1** and read the function body.
