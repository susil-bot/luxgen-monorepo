# CustomerListTabs.tsx

## File Path

`packages/ui/src/Customer/list/CustomerListTabs/CustomerListTabs.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `CustomerListTabs`?"


## Interview Questions

- Walk me through CustomerListTabsProps line by line.
...
```bash
rg "CustomerListTabs" apps packages --glob '*.{ts,tsx}'
```
