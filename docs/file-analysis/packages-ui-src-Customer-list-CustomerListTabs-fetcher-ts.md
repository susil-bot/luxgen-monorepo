...
**Path:** `packages/ui/src/Customer/list/CustomerListTabs/fetcher.ts` (9 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `customerListTabs`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `customerListTabs`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Customer/list/CustomerListTabs/fetcher.ts:3** and read the function body.
