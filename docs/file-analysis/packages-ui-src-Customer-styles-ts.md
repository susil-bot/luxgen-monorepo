...
**Path:** `packages/ui/src/Customer/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `customerStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `customerStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `customerStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Customer/styles.ts:3** and read the function body.
