# DataList.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/DataList/DataList.spec.tsx` (91 lines)  
...
**ANS.** Search imports: `rg "DataList.spec" apps packages --glob '*.{ts,tsx}'`.
