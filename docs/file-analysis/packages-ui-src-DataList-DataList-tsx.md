# DataList.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/DataList/DataList.tsx` (4 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `DataList`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `DataList`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/DataList/DataList.tsx:2** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "DataList" apps packages --glob '*.{ts,tsx}'`.
