...
`packages/ui/src/DataList/SortModal.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `panel`?"


## Interview Questions

- Walk me through SortModalProps line by line.
...
```bash
rg "SortModal" apps packages --glob '*.{ts,tsx}'
```
