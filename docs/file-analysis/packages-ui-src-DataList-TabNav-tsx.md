...
`packages/ui/src/DataList/TabNav.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `SearchIcon`?"

### `FilterLinesIcon`

- **Approx. line:** 19
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `FilterLinesIcon`?"

### `SortIcon`

- **Approx. line:** 25
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `SortIcon`?"


## Interview Questions

- Walk me through TabNavExtendedProps line by line.
...
```bash
rg "TabNav" apps packages --glob '*.{ts,tsx}'
```
