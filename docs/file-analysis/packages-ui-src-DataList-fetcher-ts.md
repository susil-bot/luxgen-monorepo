...
`packages/ui/src/DataList/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchDataListData`?"

### `fetchDataListSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchDataListSSR`?"


## Interview Questions

- Walk me through DataListData line by line.
