# EngagementBreakdown.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/EngagementBreakdown/EngagementBreakdown.spec.tsx` (47 lines)  
...
**ANS.** Search imports: `rg "EngagementBreakdown.spec" apps packages --glob '*.{ts,tsx}'`.
