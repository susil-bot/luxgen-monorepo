# EngagementBreakdown.spec.tsx

## File Path

`packages/ui/src/EngagementBreakdown/EngagementBreakdown.spec.tsx`
...
- Walk me through EngagementBreakdown.spec.tsx line by line.
...
```bash
rg "EngagementBreakdown.spec" apps packages --glob '*.{ts,tsx}'
```
