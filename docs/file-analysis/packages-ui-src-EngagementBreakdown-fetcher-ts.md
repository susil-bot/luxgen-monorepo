...
`packages/ui/src/EngagementBreakdown/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchEngagementBreakdownData`?"

### `fetchEngagementBreakdownSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchEngagementBreakdownSSR`?"


## Interview Questions

- Walk me through EngagementBreakdownData line by line.
