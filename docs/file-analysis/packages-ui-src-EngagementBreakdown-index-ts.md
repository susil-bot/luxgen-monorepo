...
`packages/ui/src/EngagementBreakdown/index.ts`
...
- `fetchEngagementBreakdownSSR`
- `engagementBreakdownFixtures`
- `engagementBreakdownStyles`
- `EngagementBreakdownTranslations`
...
- Walk me through fetchEngagementBreakdownData line by line.
