...
`packages/ui/src/EngagementBreakdown/styles.ts`
...
- **Approx. line:** 31
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getEngagementBreakdownStyles`?"


## Interview Questions

- Walk me through getEngagementBreakdownStyles line by line.
