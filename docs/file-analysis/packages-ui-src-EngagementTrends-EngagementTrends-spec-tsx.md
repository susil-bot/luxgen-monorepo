# EngagementTrends.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/EngagementTrends/EngagementTrends.spec.tsx` (34 lines)  
...
**ANS.** Search imports: `rg "EngagementTrends.spec" apps packages --glob '*.{ts,tsx}'`.
