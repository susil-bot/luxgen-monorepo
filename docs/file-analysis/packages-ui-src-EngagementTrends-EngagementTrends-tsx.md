...
`packages/ui/src/EngagementTrends/EngagementTrends.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `barWidth`?"

### `generateBars`

- **Approx. line:** 45
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `generateBars`?"

### `interactionsHeight`

- **Approx. line:** 48
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `interactionsHeight`?"

### `completionsHeight`

- **Approx. line:** 49
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `completionsHeight`?"


## Interview Questions

- Walk me through EngagementDataPoint line by line.
...
```bash
rg "EngagementTrends" apps packages --glob '*.{ts,tsx}'
```
