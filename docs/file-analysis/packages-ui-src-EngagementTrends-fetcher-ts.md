...
`packages/ui/src/EngagementTrends/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchEngagementTrendsData`?"

### `fetchEngagementTrendsSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchEngagementTrendsSSR`?"


## Interview Questions

- Walk me through EngagementTrendsData line by line.
