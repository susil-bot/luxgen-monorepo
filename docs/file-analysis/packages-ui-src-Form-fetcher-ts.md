...
`packages/ui/src/Form/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchFormData`?"

### `fetchFormSSR`

- **Approx. line:** 22
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchFormSSR`?"


## Interview Questions

- Walk me through FormData line by line.
