# GridContainer.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/GridContainer/GridContainer.spec.tsx` (71 lines)  
...
**ANS.** Search imports: `rg "GridContainer.spec" apps packages --glob '*.{ts,tsx}'`.
