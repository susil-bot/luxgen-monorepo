...
`packages/ui/src/GridContainer/fetcher.ts`
...
- `GridContainerData`
- `fetchGridContainerData`
- `fetchGridContainerSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchGridContainerData`?"

### `fetchGridContainerSSR`

- **Approx. line:** 18
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchGridContainerSSR`?"


## Interview Questions

- Walk me through GridContainerData line by line.
