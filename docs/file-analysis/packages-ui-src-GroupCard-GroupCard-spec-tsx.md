# GroupCard.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/GroupCard/GroupCard.spec.tsx` (59 lines)  
...
**ANS.** Search imports: `rg "GroupCard.spec" apps packages --glob '*.{ts,tsx}'`.
