...
`packages/ui/src/GroupCard/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupCardData`?"

### `fetchGroupCardSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupCardSSR`?"


## Interview Questions

- Walk me through GroupCardData line by line.
