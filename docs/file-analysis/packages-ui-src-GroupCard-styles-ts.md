...
**Path:** `packages/ui/src/GroupCard/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `groupCardStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `groupCardStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `groupCardStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/GroupCard/styles.ts:3** and read the function body.
