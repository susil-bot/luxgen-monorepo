# GroupDashboardCard.spec.tsx

## File Path

`packages/ui/src/GroupDashboardCard/GroupDashboardCard.spec.tsx`
...
- Walk me through GroupDashboardCard.spec.tsx line by line.
...
```bash
rg "GroupDashboardCard.spec" apps packages --glob '*.{ts,tsx}'
```
