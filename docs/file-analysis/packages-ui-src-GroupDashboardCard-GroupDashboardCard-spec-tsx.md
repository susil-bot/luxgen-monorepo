# GroupDashboardCard.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/GroupDashboardCard/GroupDashboardCard.spec.tsx` (389 lines)  
...
**ANS.** Search imports: `rg "GroupDashboardCard.spec" apps packages --glob '*.{ts,tsx}'`.
