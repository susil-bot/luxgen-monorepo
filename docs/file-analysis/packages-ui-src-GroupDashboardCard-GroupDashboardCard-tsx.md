# GroupDashboardCard.tsx

## File Path

`packages/ui/src/GroupDashboardCard/GroupDashboardCard.tsx`
...
- Walk me through GroupDashboardCardProps line by line.
...
```bash
rg "GroupDashboardCard" apps packages --glob '*.{ts,tsx}'
```
