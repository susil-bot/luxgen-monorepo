...
`packages/ui/src/GroupDashboardCard/fetcher.ts`
...
- `GroupDashboardCardData`
- `fetchGroupDashboardCardData`
- `fetchGroupDashboardCardSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupDashboardCardData`?"

### `fetchGroupDashboardCardSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupDashboardCardSSR`?"


## Interview Questions

- Walk me through GroupDashboardCardData line by line.
