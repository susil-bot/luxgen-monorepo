# GroupForm.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/GroupForm/GroupForm.spec.tsx` (96 lines)  
...
**ANS.** Search imports: `rg "GroupForm.spec" apps packages --glob '*.{ts,tsx}'`.
