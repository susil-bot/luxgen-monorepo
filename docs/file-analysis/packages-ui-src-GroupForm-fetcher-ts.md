...
`packages/ui/src/GroupForm/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupFormData`?"

### `fetchGroupFormSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupFormSSR`?"
