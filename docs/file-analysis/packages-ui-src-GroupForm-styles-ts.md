...
**Path:** `packages/ui/src/GroupForm/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `groupFormStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `groupFormStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `groupFormStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/GroupForm/styles.ts:3** and read the function body.
