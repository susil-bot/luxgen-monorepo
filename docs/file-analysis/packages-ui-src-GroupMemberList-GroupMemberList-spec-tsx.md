# GroupMemberList.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/GroupMemberList/GroupMemberList.spec.tsx` (76 lines)  
...
**ANS.** Search imports: `rg "GroupMemberList.spec" apps packages --glob '*.{ts,tsx}'`.
