...
`packages/ui/src/GroupMemberList/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupMemberListData`?"

### `fetchGroupMemberListSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchGroupMemberListSSR`?"


## Interview Questions

- Walk me through GroupMemberListData line by line.
