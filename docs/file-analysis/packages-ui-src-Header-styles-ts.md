...
**Path:** `packages/ui/src/Header/styles.ts` (129 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `headerStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `headerStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Header/styles.ts:3** and read the function body.
