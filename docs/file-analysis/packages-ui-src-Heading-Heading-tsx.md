...
`packages/ui/src/Heading/Heading.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `getSizeClass`?"
...
- Walk me through HeadingProps line by line.
...
```bash
rg "Heading" apps packages --glob '*.{ts,tsx}'
```
