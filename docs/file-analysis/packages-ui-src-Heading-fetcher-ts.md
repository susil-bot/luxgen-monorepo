...
`packages/ui/src/Heading/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchHeadingData`?"

### `fetchHeadingSSR`

- **Approx. line:** 28
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchHeadingSSR`?"


## Interview Questions

- Walk me through HeadingData line by line.
