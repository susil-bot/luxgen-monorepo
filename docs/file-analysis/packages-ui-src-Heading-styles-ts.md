...
**Path:** `packages/ui/src/Heading/styles.ts` (208 lines)  
**Role:** Shared UI component or hook

## Exports

- `headingStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `headingStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `headingStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Heading/styles.ts:3** and read the function body.
