# InputWithLabel.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/InputWithLabel/InputWithLabel.spec.tsx` (111 lines)  
...
**ANS.** Search imports: `rg "InputWithLabel.spec" apps packages --glob '*.{ts,tsx}'`.
