...
`packages/ui/src/Kicker/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchKickerData`?"

### `fetchKickerSSR`

- **Approx. line:** 32
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchKickerSSR`?"


## Interview Questions

- Walk me through KickerData line by line.
