# LastSurvey.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/LastSurvey/LastSurvey.spec.tsx` (43 lines)  
...
**ANS.** Search imports: `rg "LastSurvey.spec" apps packages --glob '*.{ts,tsx}'`.
