...
`packages/ui/src/LastSurvey/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchLastSurveyData`?"

### `fetchLastSurveySSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchLastSurveySSR`?"


## Interview Questions

- Walk me through LastSurveyData line by line.
