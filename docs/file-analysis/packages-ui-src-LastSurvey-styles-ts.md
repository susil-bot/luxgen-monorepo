...
`packages/ui/src/LastSurvey/styles.ts`
...
- **Approx. line:** 34
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getLastSurveyStyles`?"


## Interview Questions

- Walk me through getLastSurveyStyles line by line.
