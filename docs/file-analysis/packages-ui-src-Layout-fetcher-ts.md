...
`packages/ui/src/Layout/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchLayoutData`?"

### `fetchLayoutSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchLayoutSSR`?"


## Interview Questions

- Walk me through LayoutData line by line.
