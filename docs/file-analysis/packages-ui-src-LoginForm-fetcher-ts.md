...
`packages/ui/src/LoginForm/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchLoginFormData`?"

### `fetchLoginFormSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchLoginFormSSR`?"
