...
`packages/ui/src/Logout/Logout.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `handleLogoutClick`?"

### `handleLogout`

- **Approx. line:** 20
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleLogout`?"
...
- **Approx. line:** 44
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleConfirm`?"


## Interview Questions

- Walk me through Logout line by line.
...
```bash
rg "Logout" apps packages --glob '*.{ts,tsx}'
```
