...
`packages/ui/src/Logout/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchLogoutData`?"

### `fetchLogoutSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchLogoutSSR`?"


## Interview Questions

- Walk me through LogoutData line by line.
