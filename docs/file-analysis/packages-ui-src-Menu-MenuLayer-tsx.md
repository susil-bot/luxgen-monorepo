...
`packages/ui/src/Menu/MenuLayer.tsx`
...
- **Approx. line:** 116
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getLayerStyles`?"


## Interview Questions

- Walk me through MenuLayerProps line by line.
...
```bash
rg "MenuLayer" apps packages --glob '*.{ts,tsx}'
```
