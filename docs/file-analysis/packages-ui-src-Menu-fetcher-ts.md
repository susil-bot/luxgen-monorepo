...
`packages/ui/src/Menu/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchMenuData`?"

### `fetchMenuSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchMenuSSR`?"


## Interview Questions

- Walk me through MenuData line by line.
