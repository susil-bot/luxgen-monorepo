...
`packages/ui/src/NavBar/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchNavBarData`?"

### `fetchNavBarSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchNavBarSSR`?"


## Interview Questions

- How do you avoid duplicate navigation callbacks (onNavigate vs onItemClick)?
- Walk me through NavBarData line by line.
