...
`packages/ui/src/NotFound/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchNotFoundData`?"

### `fetchNotFoundSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchNotFoundSSR`?"


## Interview Questions

- Walk me through NotFoundData line by line.
