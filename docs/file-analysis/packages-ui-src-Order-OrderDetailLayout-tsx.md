# OrderDetailLayout.tsx

## File Path

`packages/ui/src/Order/OrderDetailLayout.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `OrderDetailLayout`?"


## Interview Questions

- Walk me through OrderDetailLayoutProps line by line.
...
```bash
rg "OrderDetailLayout" apps packages --glob '*.{ts,tsx}'
```
