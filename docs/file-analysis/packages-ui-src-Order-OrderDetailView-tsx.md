...
`packages/ui/src/Order/OrderDetailView.tsx`
...
- `./fetcher`
- `./translations`
- `./detail/FulfillmentSection`
- `./detail/PaymentSummarySection`
- `./detail/TimelineSection`
- `./detail/NotesSection`
- `./detail/CustomerSection`
- `./detail/ContactSection`
- `./detail/AccessSection`
- `./detail/BillingSection`
- `./detail/TagsSection`
- `./detail/ConversionSection`
...
- **Interview:** "What are inputs, outputs, and side effects of `OrderDetailView`?"


## Interview Questions

- Walk me through OrderDetailViewProps line by line.
...
```bash
rg "OrderDetailView" apps packages --glob '*.{ts,tsx}'
```
