...
`packages/ui/src/Order/detail/BillingSection/BillingSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `BillingSection`?"


## Interview Questions

- Walk me through BillingSectionProps line by line.
...
```bash
rg "BillingSection" apps packages --glob '*.{ts,tsx}'
```
