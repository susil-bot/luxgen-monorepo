...
**Path:** `packages/ui/src/Order/detail/FulfillmentSection/fetcher.ts` (4 lines)  
**Role:** Shared UI component or hook

## Exports

- `fulfillmentSectionDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `fulfillmentSectionDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `fulfillmentSectionDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Order/detail/FulfillmentSection/fetcher.ts:1** and read the function body.
