...
**Path:** `packages/ui/src/Order/detail/PaymentSummarySection/fetcher.ts` (4 lines)  
**Role:** Shared UI component or hook

## Exports

- `paymentSummaryDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `paymentSummaryDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `paymentSummaryDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Order/detail/PaymentSummarySection/fetcher.ts:1** and read the function body.
