...
`packages/ui/src/Order/detail/TimelineSection/TimelineSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `TimelineSection`?"


## Interview Questions

- Walk me through TimelineSectionProps line by line.
