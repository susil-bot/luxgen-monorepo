...
**Path:** `packages/ui/src/Order/styles.ts` (3 lines)  
**Role:** Shared UI component or hook

## Exports

- `orderDetailStyles` — line 2
...
**ANS.** Shared UI component or hook. Main exports: `orderDetailStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `orderDetailStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Order/styles.ts:2** and read the function body.
