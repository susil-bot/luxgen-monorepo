# PageWrapper.spec.tsx

## File Path

`packages/ui/src/PageWrapper/PageWrapper.spec.tsx`
...
- Walk me through PageWrapper.spec.tsx line by line.
...
```bash
rg "PageWrapper.spec" apps packages --glob '*.{ts,tsx}'
```
