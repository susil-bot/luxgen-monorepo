# PageWrapper.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/PageWrapper/PageWrapper.spec.tsx` (62 lines)  
...
**ANS.** Search imports: `rg "PageWrapper.spec" apps packages --glob '*.{ts,tsx}'`.
