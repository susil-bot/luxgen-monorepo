...
`packages/ui/src/PageWrapper/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchPageWrapperData`?"

### `fetchPageWrapperSSR`

- **Approx. line:** 20
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchPageWrapperSSR`?"


## Interview Questions

- Walk me through PageWrapperData line by line.
