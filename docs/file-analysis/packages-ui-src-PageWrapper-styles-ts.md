...
**Path:** `packages/ui/src/PageWrapper/styles.ts` (57 lines)  
**Role:** Shared UI component or hook

## Exports

- `pageWrapperStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `pageWrapperStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `pageWrapperStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/PageWrapper/styles.ts:3** and read the function body.
