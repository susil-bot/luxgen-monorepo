# PermissionRequest.spec.tsx

## File Path

`packages/ui/src/PermissionRequest/PermissionRequest.spec.tsx`
...
- Walk me through PermissionRequest.spec.tsx line by line.
...
```bash
rg "PermissionRequest.spec" apps packages --glob '*.{ts,tsx}'
```
