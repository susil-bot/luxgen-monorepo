# PermissionRequest.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/PermissionRequest/PermissionRequest.spec.tsx` (56 lines)  
...
**ANS.** Search imports: `rg "PermissionRequest.spec" apps packages --glob '*.{ts,tsx}'`.
