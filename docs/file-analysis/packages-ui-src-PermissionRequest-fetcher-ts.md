...
`packages/ui/src/PermissionRequest/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchPermissionRequestData`?"

### `fetchPermissionRequestSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchPermissionRequestSSR`?"


## Interview Questions

- Walk me through PermissionRequestData line by line.
