...
`packages/ui/src/PermissionRequest/styles.ts`
...
- **Approx. line:** 43
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getPermissionRequestStyles`?"


## Interview Questions

- Walk me through getPermissionRequestStyles line by line.
