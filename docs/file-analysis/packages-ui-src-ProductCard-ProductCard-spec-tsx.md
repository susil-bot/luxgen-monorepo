# ProductCard.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/ProductCard/ProductCard.spec.tsx` (44 lines)  
...
**ANS.** Search imports: `rg "ProductCard.spec" apps packages --glob '*.{ts,tsx}'`.
