...
`packages/ui/src/ProductCard/ProductCard.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `handleLike`?"
...
- **Approx. line:** 66
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleAddToCart`?"

### `handleViewDetails`

- **Approx. line:** 70
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleViewDetails`?"


## Interview Questions

- Walk me through ProductCardProps line by line.
...
```bash
rg "ProductCard" apps packages --glob '*.{ts,tsx}'
```
