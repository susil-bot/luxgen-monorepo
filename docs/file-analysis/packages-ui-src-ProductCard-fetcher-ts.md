...
`packages/ui/src/ProductCard/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchProductCardData`?"

### `fetchProductCardSSR`

- **Approx. line:** 70
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchProductCardSSR`?"


## Interview Questions

- Walk me through ProductCardData line by line.
