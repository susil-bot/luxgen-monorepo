# ProductEdit.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/ProductEdit/ProductEdit.spec.tsx` (87 lines)  
...
**ANS.** Search imports: `rg "ProductEdit.spec" apps packages --glob '*.{ts,tsx}'`.
