...
`packages/ui/src/ProductEdit/ProductEditForm.tsx`
...
- `./translations`
- `./sections/TitleDescriptionSection`
- `./sections/MediaSection`
- `./sections/CategorySection`
- `./sections/PricingSection`
- `./sections/InventorySection`
- `./sections/DeliverySection`
- `./sections/VariantsSection`
- `./sections/MetafieldsSection`
- `./sections/SearchListingSection`
- `./sections/TimelineSection`
- `../Timeline`
- `./sidebar/StatusSection`
- `./sidebar/PublishingSection`
- `./sidebar/SalesSection`
- `./sidebar/OrganizationSection`
...
- **Interview:** "What are inputs, outputs, and side effects of `ProductEditForm`?"


## Interview Questions

- Walk me through ProductEditFormProps line by line.
...
```bash
rg "ProductEditForm" apps packages --glob '*.{ts,tsx}'
```
