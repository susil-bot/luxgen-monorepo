...
`packages/ui/src/ProductEdit/ProductEditHeader.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `ProductEditHeader`?"


## Interview Questions

- Walk me through ProductEditHeaderProps line by line.
...
```bash
rg "ProductEditHeader" apps packages --glob '*.{ts,tsx}'
```
