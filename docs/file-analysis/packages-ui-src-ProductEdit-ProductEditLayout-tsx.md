# ProductEditLayout.tsx

## File Path

`packages/ui/src/ProductEdit/ProductEditLayout.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `ProductEditLayout`?"


## Interview Questions

- Walk me through ProductEditLayoutProps line by line.
...
```bash
rg "ProductEditLayout" apps packages --glob '*.{ts,tsx}'
```
