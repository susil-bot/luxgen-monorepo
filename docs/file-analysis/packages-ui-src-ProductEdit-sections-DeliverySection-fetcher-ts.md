...
**Path:** `packages/ui/src/ProductEdit/sections/DeliverySection/fetcher.ts` (4 lines)  
**Role:** Shared UI component or hook

## Exports

- `deliverySectionDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `deliverySectionDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `deliverySectionDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sections/DeliverySection/fetcher.ts:1** and read the function body.
