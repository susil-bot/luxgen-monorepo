...
**Path:** `packages/ui/src/ProductEdit/sections/InventorySection/fetcher.ts` (4 lines)  
**Role:** Shared UI component or hook

## Exports

- `inventorySectionDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `inventorySectionDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `inventorySectionDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sections/InventorySection/fetcher.ts:1** and read the function body.
