# MetafieldsSection.tsx

## File Path

`packages/ui/src/ProductEdit/sections/MetafieldsSection/MetafieldsSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `MetafieldsSection`?"
...
```bash
rg "MetafieldsSection" apps packages --glob '*.{ts,tsx}'
```
