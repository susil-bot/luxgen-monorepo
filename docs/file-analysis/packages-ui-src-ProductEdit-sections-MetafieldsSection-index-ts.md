...
`packages/ui/src/ProductEdit/sections/MetafieldsSection/index.ts`
...
- `MetafieldsSection`
- `productMetafields`
- `categoryMetafieldTags`
- `variantMetafieldLabels`
- `metafieldsSectionFixtures`
...
- Walk me through MetafieldsSection line by line.
