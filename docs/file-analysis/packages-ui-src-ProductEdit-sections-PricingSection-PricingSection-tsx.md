...
`packages/ui/src/ProductEdit/sections/PricingSection/PricingSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `PricingSection`?"


## Interview Questions

- Walk me through PricingSectionProps line by line.
...
```bash
rg "PricingSection" apps packages --glob '*.{ts,tsx}'
```
