...
`packages/ui/src/ProductEdit/sections/SearchListingSection/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `buildSeoPreviewUrl`?"

### `deriveUrlHandle`

- **Approx. line:** 5
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `deriveUrlHandle`?"


## Interview Questions

- Walk me through buildSeoPreviewUrl line by line.
