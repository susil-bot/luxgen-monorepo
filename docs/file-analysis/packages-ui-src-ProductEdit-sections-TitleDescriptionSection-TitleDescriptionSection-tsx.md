...
`packages/ui/src/ProductEdit/sections/TitleDescriptionSection/TitleDescriptionSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `TitleDescriptionSection`?"


## Interview Questions

- Walk me through TitleDescriptionSectionProps line by line.
...
```bash
rg "TitleDescriptionSection" apps packages --glob '*.{ts,tsx}'
```
