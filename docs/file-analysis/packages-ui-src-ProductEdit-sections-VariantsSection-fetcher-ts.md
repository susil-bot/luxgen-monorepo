...
**Path:** `packages/ui/src/ProductEdit/sections/VariantsSection/fetcher.ts` (5 lines)  
**Role:** Shared UI component or hook

## Exports

- `variantsSectionDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `variantsSectionDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `variantsSectionDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sections/VariantsSection/fetcher.ts:1** and read the function body.
