...
`packages/ui/src/ProductEdit/sidebar/OrganizationSection/OrganizationSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `OrganizationSection`?"


## Interview Questions

- Walk me through OrganizationSectionProps line by line.
...
```bash
rg "OrganizationSection" apps packages --glob '*.{ts,tsx}'
```
