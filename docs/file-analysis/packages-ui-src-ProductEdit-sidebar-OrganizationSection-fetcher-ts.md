...
**Path:** `packages/ui/src/ProductEdit/sidebar/OrganizationSection/fetcher.ts` (5 lines)  
**Role:** Shared UI component or hook

## Exports

- `organizationSectionDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `organizationSectionDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `organizationSectionDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sidebar/OrganizationSection/fetcher.ts:1** and read the function body.
