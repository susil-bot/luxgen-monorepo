...
`packages/ui/src/ProductEdit/sidebar/PublishingSection/PublishingSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `PublishingSection`?"


## Interview Questions

- Walk me through PublishingSection line by line.
...
```bash
rg "PublishingSection" apps packages --glob '*.{ts,tsx}'
```
