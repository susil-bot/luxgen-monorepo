...
**Path:** `packages/ui/src/ProductEdit/sidebar/PublishingSection/fetcher.ts` (6 lines)  
**Role:** Shared UI component or hook

## Exports

- `publishingChannels` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `publishingChannels`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `publishingChannels`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sidebar/PublishingSection/fetcher.ts:1** and read the function body.
