...
**Path:** `packages/ui/src/ProductEdit/sidebar/SalesSection/fetcher.ts` (4 lines)  
**Role:** Shared UI component or hook

## Exports

- `salesSectionDefaults` — line 1
...
**ANS.** Shared UI component or hook. Main exports: `salesSectionDefaults`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `salesSectionDefaults`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sidebar/SalesSection/fetcher.ts:1** and read the function body.
