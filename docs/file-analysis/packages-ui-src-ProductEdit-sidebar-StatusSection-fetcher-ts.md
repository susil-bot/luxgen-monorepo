...
**Path:** `packages/ui/src/ProductEdit/sidebar/StatusSection/fetcher.ts` (9 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `statusOptions`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `statusOptions`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/ProductEdit/sidebar/StatusSection/fetcher.ts:3** and read the function body.
