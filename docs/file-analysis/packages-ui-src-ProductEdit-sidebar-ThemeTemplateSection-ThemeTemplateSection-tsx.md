# ThemeTemplateSection.tsx

## File Path

`packages/ui/src/ProductEdit/sidebar/ThemeTemplateSection/ThemeTemplateSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `ThemeTemplateSection`?"


## Interview Questions

- Walk me through ThemeTemplateSectionProps line by line.
...
```bash
rg "ThemeTemplateSection" apps packages --glob '*.{ts,tsx}'
```
