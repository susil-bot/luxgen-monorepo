# RadioGroup.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/RadioGroup/RadioGroup.spec.tsx` (127 lines)  
...
**ANS.** Search imports: `rg "RadioGroup.spec" apps packages --glob '*.{ts,tsx}'`.
