...
`packages/ui/src/RadioGroup/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchRadioGroupData`?"

### `fetchRadioGroupSSR`

- **Approx. line:** 30
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchRadioGroupSSR`?"


## Interview Questions

- Walk me through RadioGroupData line by line.
