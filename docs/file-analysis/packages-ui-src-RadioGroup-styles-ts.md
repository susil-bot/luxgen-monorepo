...
**Path:** `packages/ui/src/RadioGroup/styles.ts` (252 lines)  
**Role:** Shared UI component or hook

## Exports

- `radioGroupStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `radioGroupStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `radioGroupStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/RadioGroup/styles.ts:3** and read the function body.
