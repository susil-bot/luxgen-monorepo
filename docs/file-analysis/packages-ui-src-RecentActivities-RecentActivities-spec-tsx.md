# RecentActivities.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/RecentActivities/RecentActivities.spec.tsx` (52 lines)  
...
**ANS.** Search imports: `rg "RecentActivities.spec" apps packages --glob '*.{ts,tsx}'`.
