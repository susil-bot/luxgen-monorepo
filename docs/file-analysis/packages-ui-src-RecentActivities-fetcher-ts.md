...
`packages/ui/src/RecentActivities/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchRecentActivitiesData`?"

### `fetchRecentActivitiesSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchRecentActivitiesSSR`?"


## Interview Questions

- Walk me through RecentActivitiesData line by line.
