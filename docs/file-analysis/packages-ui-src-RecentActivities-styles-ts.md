...
`packages/ui/src/RecentActivities/styles.ts`
...
- **Approx. line:** 40
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getRecentActivitiesStyles`?"


## Interview Questions

- Walk me through getRecentActivitiesStyles line by line.
