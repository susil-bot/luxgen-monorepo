# RegisterForm.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/RegisterForm/RegisterForm.spec.tsx` (129 lines)  
...
**ANS.** Search imports: `rg "RegisterForm.spec" apps packages --glob '*.{ts,tsx}'`.
