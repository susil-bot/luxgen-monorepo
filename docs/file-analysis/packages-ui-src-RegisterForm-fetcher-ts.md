...
`packages/ui/src/RegisterForm/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchRegisterFormData`?"

### `fetchRegisterFormSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchRegisterFormSSR`?"
