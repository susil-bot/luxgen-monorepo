...
`packages/ui/src/RegisterVisual/fetcher.ts`
...
- `RegisterVisualData`
- `fetchRegisterVisualData`
- `fetchRegisterVisualSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchRegisterVisualData`?"

### `fetchRegisterVisualSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchRegisterVisualSSR`?"


## Interview Questions

- Walk me through RegisterVisualData line by line.
