# SearchBar.example.tsx

## File Path

`packages/ui/src/SearchBar/SearchBar.example.tsx`
...
- Walk me through SearchBarExample line by line.
...
```bash
rg "SearchBar.example" apps packages --glob '*.{ts,tsx}'
```
