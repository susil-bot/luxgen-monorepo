# SearchBar.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/SearchBar/SearchBar.spec.tsx` (60 lines)  
...
**ANS.** Search imports: `rg "SearchBar.spec" apps packages --glob '*.{ts,tsx}'`.
