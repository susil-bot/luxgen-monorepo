...
`packages/ui/src/SearchBar/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchSearchBarData`?"

### `fetchSearchBarSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchSearchBarSSR`?"


## Interview Questions

- Walk me through SearchBarData line by line.
