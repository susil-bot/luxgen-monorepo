# LuxSidebarNavItem.tsx

## File Path

`packages/ui/src/Sidebar/LuxSidebarNavItem.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `LuxSidebarNavItem`?"
...
- Walk me through LuxSidebarNavItemProps line by line.
...
```bash
rg "LuxSidebarNavItem" apps packages --glob '*.{ts,tsx}'
```
