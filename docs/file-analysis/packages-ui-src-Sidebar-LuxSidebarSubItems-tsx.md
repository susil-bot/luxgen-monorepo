# LuxSidebarSubItems.tsx

## File Path

`packages/ui/src/Sidebar/LuxSidebarSubItems.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `LuxSidebarSubItems`?"


## Interview Questions

- How do you avoid duplicate navigation callbacks (onNavigate vs onItemClick)?
- Walk me through LuxSidebarSubItemsProps line by line.
...
```bash
rg "LuxSidebarSubItems" apps packages --glob '*.{ts,tsx}'
```
