...
`packages/ui/src/Sidebar/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchSidebarData`?"

### `fetchSidebarSSR`

- **Approx. line:** 28
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchSidebarSSR`?"


## Interview Questions

- How do you avoid duplicate navigation callbacks (onNavigate vs onItemClick)?
- Walk me through SidebarData line by line.
