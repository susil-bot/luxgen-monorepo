# Snackbar.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Snackbar/Snackbar.spec.tsx` (41 lines)  
...
**ANS.** Search imports: `rg "Snackbar.spec" apps packages --glob '*.{ts,tsx}'`.
