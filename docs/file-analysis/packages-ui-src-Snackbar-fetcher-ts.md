...
`packages/ui/src/Snackbar/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchSnackbarData`?"

### `fetchSnackbarSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchSnackbarSSR`?"


## Interview Questions

- Walk me through SnackbarData line by line.
