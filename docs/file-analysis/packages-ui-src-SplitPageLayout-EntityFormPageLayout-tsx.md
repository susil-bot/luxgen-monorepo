# EntityFormPageLayout.tsx

## File Path

`packages/ui/src/SplitPageLayout/EntityFormPageLayout.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `EntityFormPageLayout`?"


## Interview Questions

- Walk me through EntityFormPageLayoutProps line by line.
...
```bash
rg "EntityFormPageLayout" apps packages --glob '*.{ts,tsx}'
```
