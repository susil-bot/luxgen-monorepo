# SplitPageFormField.tsx

## File Path

`packages/ui/src/SplitPageLayout/SplitPageFormField.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `SplitPageFormField`?"


## Interview Questions

- Walk me through SplitPageFormFieldProps line by line.
...
```bash
rg "SplitPageFormField" apps packages --glob '*.{ts,tsx}'
```
