# SplitPageLayout.spec.tsx

## File Path

`packages/ui/src/SplitPageLayout/SplitPageLayout.spec.tsx`
...
- Walk me through SplitPageLayout.spec.tsx line by line.
...
```bash
rg "SplitPageLayout.spec" apps packages --glob '*.{ts,tsx}'
```
