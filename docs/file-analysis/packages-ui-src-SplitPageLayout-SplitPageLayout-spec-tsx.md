# SplitPageLayout.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/SplitPageLayout/SplitPageLayout.spec.tsx` (34 lines)  
...
**ANS.** Search imports: `rg "SplitPageLayout.spec" apps packages --glob '*.{ts,tsx}'`.
