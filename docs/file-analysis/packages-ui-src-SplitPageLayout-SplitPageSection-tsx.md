# SplitPageSection.tsx

## File Path

`packages/ui/src/SplitPageLayout/SplitPageSection.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `SplitPageSection`?"


## Interview Questions

- Walk me through SplitPageSectionProps line by line.
...
```bash
rg "SplitPageSection" apps packages --glob '*.{ts,tsx}'
```
