...
`packages/ui/src/SplitPageLayout/index.ts`
...
- `splitPageDefaults`
- `splitPageStyles`
- `splitPageLayoutFixtures`
- `SplitPageLayoutTranslations`
- `splitPageLayoutStyles`
...
- Walk me through SplitPageLayout line by line.
