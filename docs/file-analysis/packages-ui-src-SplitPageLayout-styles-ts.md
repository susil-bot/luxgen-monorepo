...
**Path:** `packages/ui/src/SplitPageLayout/styles.ts` (11 lines)  
**Role:** Shared UI component or hook

## Exports

- `splitPageLayoutStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `splitPageLayoutStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `splitPageLayoutStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/SplitPageLayout/styles.ts:3** and read the function body.
