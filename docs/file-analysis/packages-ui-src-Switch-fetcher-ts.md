...
`packages/ui/src/Switch/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchSwitchData`?"

### `fetchSwitchSSR`

- **Approx. line:** 22
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchSwitchSSR`?"


## Interview Questions

- Walk me through SwitchData line by line.
