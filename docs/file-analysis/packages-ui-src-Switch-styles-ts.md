...
**Path:** `packages/ui/src/Switch/styles.ts` (231 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `switchStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `switchStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Switch/styles.ts:3** and read the function body.
