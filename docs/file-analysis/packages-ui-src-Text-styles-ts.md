...
**Path:** `packages/ui/src/Text/styles.ts` (174 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `textStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `textStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Text/styles.ts:3** and read the function body.
