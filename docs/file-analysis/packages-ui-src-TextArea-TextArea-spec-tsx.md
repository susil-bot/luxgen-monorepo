# TextArea.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/TextArea/TextArea.spec.tsx` (103 lines)  
...
**ANS.** Search imports: `rg "TextArea.spec" apps packages --glob '*.{ts,tsx}'`.
