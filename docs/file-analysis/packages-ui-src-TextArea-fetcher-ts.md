...
`packages/ui/src/TextArea/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchTextAreaData`?"

### `fetchTextAreaSSR`

- **Approx. line:** 24
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchTextAreaSSR`?"


## Interview Questions

- Walk me through TextAreaData line by line.
