...
**Path:** `packages/ui/src/TextArea/styles.ts` (167 lines)  
**Role:** Shared UI component or hook

## Exports

- `textAreaStyles` — line 3
...
**ANS.** Shared UI component or hook. Main exports: `textAreaStyles`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `textAreaStyles`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/TextArea/styles.ts:3** and read the function body.
