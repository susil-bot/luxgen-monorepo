# Timeline.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Timeline/Timeline.spec.tsx` (51 lines)  
...
**ANS.** Search imports: `rg "Timeline.spec" apps packages --glob '*.{ts,tsx}'`.
