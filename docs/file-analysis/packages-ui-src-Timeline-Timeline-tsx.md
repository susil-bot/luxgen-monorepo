# Timeline.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/Timeline/Timeline.tsx` (4 lines)  
...
**ANS.** Shared UI component or hook. Main exports: `Timeline`.

--------------------------------------------------------------------------------------------------------------------------------------------
**[1] What is `Timeline`?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Exported symbol — open source at **packages/ui/src/Timeline/Timeline.tsx:2** and read the function body.

--------------------------------------------------------------------------------------------------------------------------------------------
**[2] What breaks if we delete this file?**
--------------------------------------------------------------------------------------------------------------------------------------------

**ANS.** Search imports: `rg "Timeline" apps packages --glob '*.{ts,tsx}'`.
