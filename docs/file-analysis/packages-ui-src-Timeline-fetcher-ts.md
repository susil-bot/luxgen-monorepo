...
`packages/ui/src/Timeline/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `formatTimelineTime`?"

### `formatTimelineDateHeader`

- **Approx. line:** 48
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `formatTimelineDateHeader`?"

### `groupTimelineByDate`

- **Approx. line:** 64
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `groupTimelineByDate`?"

### `timelineActorLabel`

- **Approx. line:** 81
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `timelineActorLabel`?"


## Interview Questions

- Walk me through TimelineSubjectType line by line.
