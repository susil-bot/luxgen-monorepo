...
`packages/ui/src/Toolkit/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchToolkitData`?"

### `fetchToolkitSSR`

- **Approx. line:** 25
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchToolkitSSR`?"


## Interview Questions

- Walk me through ToolkitData line by line.
