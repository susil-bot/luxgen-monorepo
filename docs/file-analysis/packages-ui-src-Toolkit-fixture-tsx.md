...
`packages/ui/src/Toolkit/fixture.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `AddIcon`?"

### `EditIcon`

- **Approx. line:** 11
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `EditIcon`?"

### `TrashIcon`

- **Approx. line:** 23
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `TrashIcon`?"


## Interview Questions

- Walk me through toolkitFixtures line by line.
