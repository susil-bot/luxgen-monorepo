# UserDashboard.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/UserDashboard/UserDashboard.spec.tsx` (26 lines)  
...
**ANS.** Search imports: `rg "UserDashboard.spec" apps packages --glob '*.{ts,tsx}'`.
