...
`packages/ui/src/UserDashboard/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserDashboardData`?"

### `fetchUserDashboardSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserDashboardSSR`?"


## Interview Questions

- Walk me through UserDashboardData line by line.
