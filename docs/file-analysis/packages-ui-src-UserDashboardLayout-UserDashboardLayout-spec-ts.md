# UserDashboardLayout.spec.ts — Brief + Junior Q&A

**Path:** `packages/ui/src/UserDashboardLayout/UserDashboardLayout.spec.ts` (9 lines)  
...
**ANS.** Search imports: `rg "UserDashboardLayout.spec" apps packages --glob '*.{ts,tsx}'`.
