...
`packages/ui/src/UserDashboardLayout/UserDashboardLayout.tsx`
...
- Walk me through UserDashboardLayoutProps line by line.
...
```bash
rg "UserDashboardLayout" apps packages --glob '*.{ts,tsx}'
```
