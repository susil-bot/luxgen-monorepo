...
`packages/ui/src/UserDashboardLayout/fetcher.ts`
...
- `UserDashboardLayoutData`
- `fetchUserDashboardLayoutData`
- `fetchUserDashboardLayoutSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserDashboardLayoutData`?"

### `fetchUserDashboardLayoutSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserDashboardLayoutSSR`?"


## Interview Questions

- Walk me through UserDashboardLayoutData line by line.
