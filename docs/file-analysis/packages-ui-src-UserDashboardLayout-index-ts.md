...
`packages/ui/src/UserDashboardLayout/index.ts`
...
- `userDashboardLayoutFixtures`
- `userDashboardLayoutStyles`
- `UserDashboardLayoutTranslations`
...
- Walk me through UserDashboardLayout line by line.
