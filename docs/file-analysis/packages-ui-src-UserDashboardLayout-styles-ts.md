...
`packages/ui/src/UserDashboardLayout/styles.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `getUserDashboardLayoutStyles`?"


## Interview Questions

- Walk me through getUserDashboardLayoutStyles line by line.
