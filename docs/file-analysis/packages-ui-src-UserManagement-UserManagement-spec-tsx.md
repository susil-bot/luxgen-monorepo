# UserManagement.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/UserManagement/UserManagement.spec.tsx` (84 lines)  
...
**ANS.** Search imports: `rg "UserManagement.spec" apps packages --glob '*.{ts,tsx}'`.
