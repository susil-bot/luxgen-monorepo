...
`packages/ui/src/UserManagement/UserManagement.spec.tsx`
...
- Walk me through UserManagement.spec.tsx line by line.
...
```bash
rg "UserManagement.spec" apps packages --glob '*.{ts,tsx}'
```
