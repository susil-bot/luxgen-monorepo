...
`packages/ui/src/UserManagement/UserRow.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `getStatusVariant`?"

### `getRoleIcon`

- **Approx. line:** 25
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getRoleIcon`?"
...
- **Approx. line:** 48
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `handleAction`?"


## Interview Questions

- Walk me through UserRow line by line.
...
```bash
rg "UserRow" apps packages --glob '*.{ts,tsx}'
```
