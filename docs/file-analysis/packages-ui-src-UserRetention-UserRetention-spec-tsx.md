# UserRetention.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/UserRetention/UserRetention.spec.tsx` (32 lines)  
...
**ANS.** Search imports: `rg "UserRetention.spec" apps packages --glob '*.{ts,tsx}'`.
