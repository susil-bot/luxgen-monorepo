# UserRetention.spec.tsx

## File Path

`packages/ui/src/UserRetention/UserRetention.spec.tsx`
...
- Walk me through UserRetention.spec.tsx line by line.
...
```bash
rg "UserRetention.spec" apps packages --glob '*.{ts,tsx}'
```
