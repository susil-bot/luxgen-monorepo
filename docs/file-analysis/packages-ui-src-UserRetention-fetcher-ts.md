...
`packages/ui/src/UserRetention/fetcher.ts`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserRetentionData`?"

### `fetchUserRetentionSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserRetentionSSR`?"


## Interview Questions

- Walk me through UserRetentionData line by line.
