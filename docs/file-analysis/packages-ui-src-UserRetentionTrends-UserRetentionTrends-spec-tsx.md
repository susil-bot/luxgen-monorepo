# UserRetentionTrends.spec.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/UserRetentionTrends/UserRetentionTrends.spec.tsx` (27 lines)  
...
**ANS.** Search imports: `rg "UserRetentionTrends.spec" apps packages --glob '*.{ts,tsx}'`.
