# UserRetentionTrends.tsx

## File Path

`packages/ui/src/UserRetentionTrends/UserRetentionTrends.tsx`
...
- **Interview:** "What are inputs, outputs, and side effects of `generatePath`?"

### `x`

- **Approx. line:** 44
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `x`?"

### `generateAreaPath`

- **Approx. line:** 65
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `generateAreaPath`?"


## Interview Questions

- Walk me through RetentionDataPoint line by line.
...
```bash
rg "UserRetentionTrends" apps packages --glob '*.{ts,tsx}'
```
