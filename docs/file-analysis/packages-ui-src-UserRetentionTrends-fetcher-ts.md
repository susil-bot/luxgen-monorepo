...
`packages/ui/src/UserRetentionTrends/fetcher.ts`
...
- `UserRetentionTrendsData`
- `fetchUserRetentionTrendsData`
- `fetchUserRetentionTrendsSSR`
...
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserRetentionTrendsData`?"

### `fetchUserRetentionTrendsSSR`

- **Approx. line:** 12
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `fetchUserRetentionTrendsSSR`?"


## Interview Questions

- Walk me through UserRetentionTrendsData line by line.
