...
`packages/ui/src/UserRetentionTrends/index.ts`
...
- `userRetentionTrendsFixtures`
- `userRetentionTrendsStyles`
- `UserRetentionTrendsTranslations`
...
- Walk me through fetchUserRetentionTrendsData line by line.
