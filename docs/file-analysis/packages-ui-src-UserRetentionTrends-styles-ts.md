...
`packages/ui/src/UserRetentionTrends/styles.ts`
...
- **Approx. line:** 31
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `getUserRetentionStyles`?"


## Interview Questions

- Walk me through getUserRetentionStyles line by line.
