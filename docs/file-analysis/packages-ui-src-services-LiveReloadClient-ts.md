...
`packages/ui/src/services/LiveReloadClient.ts`
...
- Walk me through LiveReloadClient line by line.
...
```bash
rg "LiveReloadClient" apps packages --glob '*.{ts,tsx}'
```
