...
- **Interview:** "What are inputs, outputs, and side effects of `isValidEmail`?"

### `passwordMeetsMinimum`

- **Approx. line:** 10
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `passwordMeetsMinimum`?"

### `passwordErrorMessage`

- **Approx. line:** 14
- **Role:** Implementation detail — open source file for full signature.
- **Interview:** "What are inputs, outputs, and side effects of `passwordErrorMessage`?"


## Interview Questions

- Walk me through EMAIL_REGEX line by line.
