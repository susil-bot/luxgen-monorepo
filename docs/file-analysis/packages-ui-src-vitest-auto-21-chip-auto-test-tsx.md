# 21-chip.auto.test.tsx

## File Path

`packages/ui/src/vitest-auto/21-chip.auto.test.tsx`
...
- Walk me through 21-chip.auto.test.tsx line by line.
...
```bash
rg "21-chip.auto.test" apps packages --glob '*.{ts,tsx}'
```
