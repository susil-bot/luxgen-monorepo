# 22-heading.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/22-heading.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "22-heading.auto.test" apps packages --glob '*.{ts,tsx}'`.
