# 22-heading.auto.test.tsx

## File Path

`packages/ui/src/vitest-auto/22-heading.auto.test.tsx`
...
- Walk me through 22-heading.auto.test.tsx line by line.
...
```bash
rg "22-heading.auto.test" apps packages --glob '*.{ts,tsx}'
```
