# 23-badge.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/23-badge.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "23-badge.auto.test" apps packages --glob '*.{ts,tsx}'`.
