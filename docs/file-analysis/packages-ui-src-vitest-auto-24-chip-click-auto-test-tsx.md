# 24-chip-click.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/24-chip-click.auto.test.tsx` (14 lines)  
...
**ANS.** Search imports: `rg "24-chip-click.auto.test" apps packages --glob '*.{ts,tsx}'`.
