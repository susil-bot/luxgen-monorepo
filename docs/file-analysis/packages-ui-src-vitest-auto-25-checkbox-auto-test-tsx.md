# 25-checkbox.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/25-checkbox.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "25-checkbox.auto.test" apps packages --glob '*.{ts,tsx}'`.
