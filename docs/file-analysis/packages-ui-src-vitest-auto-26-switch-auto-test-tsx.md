# 26-switch.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/26-switch.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "26-switch.auto.test" apps packages --glob '*.{ts,tsx}'`.
