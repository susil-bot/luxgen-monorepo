# 27-notfound.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/27-notfound.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "27-notfound.auto.test" apps packages --glob '*.{ts,tsx}'`.
