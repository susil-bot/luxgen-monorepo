# 28-card.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/28-card.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "28-card.auto.test" apps packages --glob '*.{ts,tsx}'`.
