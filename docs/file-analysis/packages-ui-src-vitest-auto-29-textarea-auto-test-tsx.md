# 29-textarea.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/29-textarea.auto.test.tsx` (11 lines)  
...
**ANS.** Search imports: `rg "29-textarea.auto.test" apps packages --glob '*.{ts,tsx}'`.
