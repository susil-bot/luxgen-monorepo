# 30-navbar-guest.auto.test.tsx

## File Path

`packages/ui/src/vitest-auto/30-navbar-guest.auto.test.tsx`
...
- Walk me through 30-navbar-guest.auto.test.tsx line by line.
...
```bash
rg "30-navbar-guest.auto.test" apps packages --glob '*.{ts,tsx}'
```
