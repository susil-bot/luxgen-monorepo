# 30-navbar-guest.auto.test.tsx — Brief + Junior Q&A

**Path:** `packages/ui/src/vitest-auto/30-navbar-guest.auto.test.tsx` (12 lines)  
...
**ANS.** Search imports: `rg "30-navbar-guest.auto.test" apps packages --glob '*.{ts,tsx}'`.
