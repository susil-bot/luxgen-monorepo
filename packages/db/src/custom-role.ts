...
export interface ICustomRolePermissions {
  canManageUsers: boolean; canManageCourses: boolean; canManageGroups: boolean;
  canViewReports: boolean; canManageSettings: boolean;
}
export interface ICustomRole extends Document {
  tenant: Types.ObjectId; name: string; description?: string;
  permissions: ICustomRolePermissions; createdAt: Date; updatedAt: Date;
}
