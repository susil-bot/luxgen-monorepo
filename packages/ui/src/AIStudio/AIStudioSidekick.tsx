...
function IconButton({ label, onClick, children }: { label: string; onClick?: () => void; children: React.ReactNode }) {
  return (
    <button type="button" onClick={onClick} aria-label={label} title={label} className="lux-sidekick-icon-btn">
      {children}
    </button>
  );
}
        ...
        <button type="button" className="lux-sidekick-feedback-btn" aria-label="Helpful">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M14 9V5a3 3 0 00-3-3l-4 9v11h11.28a2 2 0 002-1.7l1.38-9a2 2 0 00-2-2.3H14zM4 22H2a1 1 0 01-1-1v-7a1 1 0 011-1h2"
            />
          </svg>
        </button>
        <button type="button" className="lux-sidekick-feedback-btn" aria-label="Not helpful">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M10 15v4a3 3 0 003 3l4-9V3H6.72a2 2 0 00-2 1.7l-1.38 9a2 2 0 002 2.3H10zM20 2h2a1 1 0 011 1v7a1 1 0 01-1 1h-2"
            />
          </svg>
        </button>
      </div>
