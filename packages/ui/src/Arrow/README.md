...
```tsx
<Arrow direction="up" size="large" variant="outline" onClick={scrollToTop} aria-label="Scroll to top" />
```
...
```tsx
<Arrow direction="left" className="shadow-lg hover:shadow-xl transition-shadow" />
```
