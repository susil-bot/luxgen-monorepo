...
const sampleItems: CarouselItem[] = [
  ...
  },
  {
    id: '2',
    content: (
      <div style={{ padding: '2rem', textAlign: 'center', background: '#e5e7eb', borderRadius: '0.5rem' }}>
        Slide 2 Content
      </div>
    ),
    title: 'Slide 2',
  ...
  },
  {
    id: '3',
    content: (
      <div style={{ padding: '2rem', textAlign: 'center', background: '#d1d5db', borderRadius: '0.5rem' }}>
        Slide 3 Content
      </div>
    ),
    title: 'Slide 3',
