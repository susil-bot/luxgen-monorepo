...
export const fetchPageWrapperData = async (tenantId?: string): Promise<PageWrapperData> => {
...
export const fetchPageWrapperSSR = async (tenantId?: string): Promise<{ html: string; styles: string }> => {
