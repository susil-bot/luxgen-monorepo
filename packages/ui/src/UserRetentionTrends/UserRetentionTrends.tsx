...
export interface UserRetentionTrendsProps extends BaseComponentProps {
...
const UserRetentionTrendsComponent: React.FC<UserRetentionTrendsProps> = ({
...
export const UserRetentionTrends = withSSR(UserRetentionTrendsComponent);
